...
| CFI | = Captive Financial Institutions and Money lenders |
| --- | --- |

4. De volgende MER-profielen worden onderscheiden:

| MRS-SHSI | = Securities Holdings and Securities Issued (activa en passiva); |
| --- | --- |
| MRS-HOLD | = Holdings (activa); |
| MRS-CUST | = Custodians (bewaarbedrijven); |
| MRS-SV | = Securitization Vehicle (securitisatie vehikel). |
