...
De Leidraad Invordering 2008 is in de plaats getreden van de [Leidraad Invordering 1990](https://wetten.overheid.nl/jci1.3:c:BWBR0004800). De Leidraad Invordering 2008 bevat alleen nog beleidsregels. Werkinstructies en teksten die terug te vinden zijn in wet en regelgeving zijn niet opgenomen.

### 1.1.1. Lijst met gebruikte afkortingen

### 1.1.1. Lijst met gebruikte afkortingen

Onder de overige in deze leidraad gebruikte begrippen wordt hetzelfde verstaan als de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) daaronder verstaat.
...
Belastingdeurwaarder is de door of namens de minister van Financiën als zodanig aangewezen ambtenaar van de Rijksbelastingdienst. De rechten en plichten uit de [Ambtenarenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0001947) zijn op hem van toepassing. In de uitoefening van zijn functie is de belastingdeurwaarder bestuursorgaan in de zin van de [Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537), dan wel handelt hij onder de verantwoordelijkheid van een bestuursorgaan (de ontvanger).
...
Om misverstanden te voorkomen, meldt de belastingdeurwaarder steeds in welke hoedanigheid hij optreedt en hij legitimeert zich desgevraagd. Op grond van [artikel 67 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=67) is het de belastingdeurwaarder verboden om hetgeen hem over de persoon of de zaken van een ander blijkt of wordt meegedeeld – in enige werkzaamheid bij de uitvoering van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770), of in verband daarmee – verder bekend te maken dan nodig is voor de uitvoering van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) of voor de heffing van enige rijksbelasting.

### 1.1.11. Bewaren invorderingsbescheiden

Op grond van [artikel 9:1 Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=9:1) heeft een ieder het recht om een klacht in te dienen over de wijze waarop de belastingdeurwaarder zich jegens hem of een ander heeft gedragen. Klachten in verband met zijn ambtsuitoefening kunnen worden ingediend bij de ontvanger in wiens opdracht en onder wiens verantwoordelijkheid de belastingdeurwaarder werkzaam is.
...
De ontvanger maakt van de bevoegdheden van [hoofdstuk VII van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&hoofdstuk=VII) enkel gebruik bij een betalingsachterstand, dat wil zeggen als niet is betaald binnen de betalingstermijn(en) die voor de belastingaanslag gelden. De informatieplicht vervalt zodra volledige betaling plaatsvindt.

### 1.1.14. Diplomatieke status

De ontvanger kan altijd gebruik maken van zijn bevoegdheid van [hoofdstuk VII](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&hoofdstuk=VII) als de toepassing van [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) aan de orde kan komen.
...
De ontvanger handelt zoveel mogelijk in overeenstemming met de [Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537) en het [Besluit fiscaal bestuursrecht](https://wetten.overheid.nl/jci1.3:c:BWBR0023328) (zie ook artikel 1.1.5 van deze leidraad).

### Artikel 2. Begrippen

In aansluiting op [artikel 2 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=2) beschrijft dit artikel het beleid over het begrip ‘woonplaats’.

De begrippen ‘woonplaats’ en ‘plaats van vestiging’ hebben bij de uitvoering van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) niet steeds dezelfde inhoud.

De begrippen ‘woonplaats’ en ‘plaats van vestiging’ hebben bij de uitvoering van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) niet steeds dezelfde inhoud.

### Artikel 3. Bevoegdheden ontvanger

Bij de aansprakelijkheidsbepalingen van [Afdeling 1 van Hoofdstuk VI van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&afdeling=1) ligt het voor de hand om aan te sluiten bij de begrippen ‘woonplaats’ en ‘plaats van vestiging’ die gelden voor de heffingswet op grond waarvan de belastingschuld – waarvoor de aansprakelijkheid bestaat – is ontstaan.

### Artikel 3. Bevoegdheden ontvanger

In aansluiting op [artikel 3 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=3) beschrijft dit artikel het beleid over:

De ontvanger beschikt op grond van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) over diverse specifieke bevoegdheden om een belastingschuld in te vorderen. Daarnaast heeft hij alle bevoegdheden die op grond van enigerlei wettelijke bepaling aan een schuldeiser toekomen. Dit leidt er in veel gevallen toe dat de ontvanger zowel gebruik kan maken van zijn specifieke fiscale bevoegdheden, als van zijn algemene civielrechtelijke bevoegdheden om zijn doel te bereiken.
...
Er zijn in deze leidraad op [artikel 3a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=3a) geen beleidsregels gemaakt.

### Artikel 4. Bevoegdheid belastingdeurwaarder

In aansluiting op [artikel 4 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=4) beschrijft dit artikel het beleid over de reikwijdte van die bevoegdheid.
...
Dit brengt met zich mee dat de belastingdeurwaarder ook bevoegd is tot die werkzaamheden die voortvloeien uit de invordering langs civielrechtelijke weg, waartoe de ontvanger op grond van [artikel 4:124 van de Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=4:124) gerechtigd is en tot die werkzaamheden die verricht moeten worden, wanneer de ontvanger zelfstandig eisend en verwerend in rechte optreedt.

### Artikel 5

Er zijn in deze leidraad op [artikel 5 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=5) geen beleidsregels gemaakt.

### Artikel 6. Reikwijdte van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770)

In aansluiting op [artikel 6 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=6) beschrijft dit artikel het beleid over rente en kosten.

Onder rente als bedoeld in [artikel 6 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=6) wordt alleen verstaan: de invorderingsrente.
...
Onder rente als bedoeld in [artikel 7 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7) wordt alleen verstaan: de invorderingsrente.

### 7.5. Het toerekenen van kosten bij meerdere aanslagen

Onder betalingskorting wordt in dit verband verstaan: de teruggenomen betalingskorting wegens een verleende vermindering die abusievelijk niet op grond van [artikel 24, vierde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=24) is verrekend met het uit te betalen bedrag van de vermindering van de belastingaanslag waarvoor de betalingskorting is verleend. Omdat in voorkomende gevallen tevens kosten in rekening kunnen worden gebracht voor de invordering van de teruggenomen betalingskorting, is de betalingskorting tevens opgenomen in de toerekeningsregel van [artikel 7, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7).
...
Het resterende bedrag wordt afgeboekt op de onderliggende belastingaanslag – waarbij [artikel 7 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7) wel van toepassing is – echter met dien verstande dat de invorderingsrente en kosten die op die aanslag zelf betrekking hebben alleen worden afgeboekt indien en voor zover men hiervoor aansprakelijk is gesteld.
...
Uitbetalingsfouten die het gevolg zijn van de aanwijzing door de belastingschuldige van een niet op zijn naam staande bankrekening, blijven voor diens rekening. De ontvanger beroept zich in dat geval op het bevrijdende karakter van de (uit)betaling ([artikel 6:34 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0005289&artikel=34)). Desgevraagd wordt de belastingschuldige op de hoogte gesteld omtrent de naam-, adres- en woonplaatsgegevens van de derde aan wie onverschuldigd is betaald. Het bovenstaande geldt niet voor uitbetalingen van inkomstenbelasting en toeslagen, omdat dergelijke uitbetalingen uitsluitend plaatsvinden op een rekeningnummer waarvan de Belastingdienst vooraf de tenaamstelling heeft gecontroleerd.

### Artikel 7b. Cessie- en verpandingsverbod uitbetalingen inkomstenbelasting

Er zijn in deze leidraad op [artikel 7b van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7b) geen beleidsregels gemaakt.

### Artikel 8. Bekendmaking aanslag

In aansluiting op [artikel 8 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=8) beschrijft dit artikel het beleid over:
...
De wijze van bekendmaking van de belastingaanslag, bedoeld in [artikel 8 tweede lid van de Wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=8), is ter beoordeling van de ontvanger. Bij deze beoordeling kunnen onder andere de volgende factoren een rol spelen:
...
In aansluiting op [artikel 9 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9) beschrijft dit artikel het beleid over:

### 9.1. Afwijking van de betalingstermijnen in geval van voorlopige aanslagen

In de gevallen waarin voor voorlopige aanslagen (bedoeld in [artikel 9, vijfde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9)) die zijn gedagtekend in november of eerder, toepassing van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) er toe zou leiden dat de enige of laatste betalingstermijn eindigt voor 31 december, dan wordt de vervaldag van deze termijn op 31 december gesteld. Bij afwijkende boekjaren wordt de laatste vervaldag steeds op de laatste dag van de maand gesteld.

### 9.2. Afwijking van de betalingstermijnen in geval van voorlopige teruggaven

In de volgende gevallen is afwijking mogelijk van de termijnen – bedoeld in [artikel 9, zesde en zevende lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9) – die betrekking hebben op voorlopige teruggaven:
...
Op grond van [artikel 2, tweede lid, onderdeel e., van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=2) wordt onder het begrip ‘invorderen van rijksbelasting’ mede verstaan het betalen van een terug te geven bedrag aan rijksbelastingen. Op grond van deze definitie is de betalingstermijn voor een belastingaanslag zoals vastgelegd in [artikel 9, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9), ook van toepassing op de uitbetaling van een belastingteruggaaf. Hieruit volgt dat de ontvanger niet in verzuim is met de uitbetaling van een belastingteruggaaf zolang die binnen deze betalingstermijn plaats vindt.

### Artikel 10. Versnelde invordering

In aansluiting op [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) beschrijft dit artikel het beleid over:

In aansluiting op [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) beschrijft dit artikel het beleid over:

Als de ontvanger het in een specifiek geval noodzakelijk acht daadwerkelijk tot versnelde invordering (als bedoeld in [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10)) over te gaan, dan vermeldt hij op het uit te reiken of te verzenden aanslagbiljet dat de belastingaanslag terstond en tot het volle bedrag invorderbaar is. Voorts vermeldt de ontvanger op het aanslagbiljet het onderdeel van het [eerste lid van artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) op grond waarvan hij tot versnelde invordering overgaat.

Als de ontvanger het in een specifiek geval noodzakelijk acht daadwerkelijk tot versnelde invordering (als bedoeld in [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10)) over te gaan, dan vermeldt hij op het uit te reiken of te verzenden aanslagbiljet dat de belastingaanslag terstond en tot het volle bedrag invorderbaar is. Voorts vermeldt de ontvanger op het aanslagbiljet het onderdeel van het [eerste lid van artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) op grond waarvan hij tot versnelde invordering overgaat.

### 10.2. vrees voor verduistering en versnelde invordering

Veelal zal dan ook gebruik worden gemaakt van de versnelde dwanginvorderingsprocedure als bedoeld in [artikel 15 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=15), zodat vermelding op het dwangbevel dat de belastingaanslag terstond en tot het volle bedrag invorderbaar is verklaard tot de mogelijkheden van mededeling behoort. In het laatste geval zal de betekening van het dwangbevel overigens niet per post kunnen plaatsvinden. De belastingdeurwaarder zal voordat tot de versnelde dwanginvordering als bedoeld in [artikel 15 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=15) wordt overgegaan – als sprake is van direct contact met de belastingschuldige – deze eerst in de gelegenheid stellen om onmiddellijk te betalen.
...
Van gegronde vrees voor verduistering van goederen van de belastingschuldige als bedoeld in [artikel 10, eerste lid, onderdeel b, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) is sprake, als de ontvanger aannemelijk kan maken dat redelijkerwijs te verwachten is dat niet alleen het verhaal op een aantal goederen van de belastingschuldige metterdaad onmogelijk zal worden gemaakt, maar ook dat daardoor de verhaalbaarheid van de belastingschuld in ernstig gevaar zal komen.

Van gegronde vrees voor verduistering van goederen van de belastingschuldige als bedoeld in [artikel 10, eerste lid, onderdeel b, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) is sprake, als de ontvanger aannemelijk kan maken dat redelijkerwijs te verwachten is dat niet alleen het verhaal op een aantal goederen van de belastingschuldige metterdaad onmogelijk zal worden gemaakt, maar ook dat daardoor de verhaalbaarheid van de belastingschuld in ernstig gevaar zal komen.

### 10.3. Metterwoon verlaten van Nederland en versnelde invordering

Als verduistering wordt gevreesd van goederen waarvan na versnelde beslaglegging blijkt dat deze uitsluitend van een derde zijn, is niet voldaan aan [artikel 10, eerste lid, onderdeel b, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) en is het beslag niet rechtsgeldig. Het beslag hoeft dan niet formeel te worden opgeheven maar de ontvanger moet de betrokkenen wel informeren over het feit dat er geen beslag ligt.
...
### 10.7. Vordering ex [artikel 19](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) en versnelde invordering

De ontvanger mag geen vordering als bedoeld in [artikel 19 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) doen, enkel om te bereiken dat daardoor een belastingaanslag terstond en tot het volle bedrag invorderbaar wordt.
...
In aansluiting op [artikel 11 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=11) beschrijft dit artikel het beleid over:
...
In aansluiting op [artikel 12 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=12) beschrijft dit artikel het beleid over:
...
In aansluiting op [artikel 13 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=13) beschrijft dit artikel het beleid over:
...
In aansluiting op [artikel 4:116 van de Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=4:116) en [artikel 14 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=14) beschrijft dit artikel het beleid over:

De tenuitvoerlegging gebeurt op de voet van het [Wetboek van Burgerlijke Rechtsvordering](https://wetten.overheid.nl/jci1.3:c:BWBR0001827) dat toelaat de verschillende mogelijkheden van tenuitvoerlegging tegelijkertijd te benutten.
...
Als degene tegen wie het dwangbevel is uitgevaardigd, is overleden, gaat de belastingdeurwaarder pas tot tenuitvoerlegging over nadat de termijn van drie maanden als bedoeld in [artikel 4:185 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0002761&artikel=185) is verstreken, tenzij hiermee de belangen van de Staat worden geschaad. Hierbij is het niet van belang of de erfgenamen de nalatenschap zuiver hebben aanvaard.
...
Als sprake is van beslag op roerende zaken, dan deelt de belastingdeurwaarder de nieuwe verkoopdatum bij exploot aan de belastingschuldige mee, tenzij deze nieuwe datum op grond van een schriftelijke overeenkomst tussen de ontvanger en de belastingschuldige is verschoven. Het opschorten van de verkoopdatum houdt op zich geen uitstel van betaling in, in de zin van [artikel 25 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=25).
...
Als op een inbeslaggenomen goed ook een strafrechtelijk beslag ex [artikel 94 Sv](https://wetten.overheid.nl/jci1.3:c:BWBR0001903&artikel=94) rust – dat wil zeggen niet zijnde een beslag in het kader van een ontnemingsmaatregel – dan wordt het beslag dat de belastingdeurwaarder heeft gelegd pas vervolgd nadat het strafrechtelijke beslag is opgeheven.
...
Als een derde bij de belastingdeurwaarder bezwaar maakt tegen de inbeslagname van bepaalde roerende zaken waarvan hij de eigendom claimt, wijst de belastingdeurwaarder op de mogelijkheid een beroepschrift in te dienen bij de directeur op grond van [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) en eventueel in verzet te gaan op grond van [artikel 456](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=456) of [artikel 435 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435).
...
De ontvanger kan het restant van de schuld van belastingschuldige aan een derde op grond van [artikel 6:30 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0005289&artikel=30) voldoen in afwachting van verrekening met de belastingschuldige, als de belastingdeurwaarder de volgende zaken aantreft:
...
Dit laatste geldt ook als de verwachting is gerechtvaardigd dat de derde voor de executoriale verkoop een beroep zal doen als bedoeld in [artikel 461d Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=461d).

Nadat op roerende zaken beslag is gelegd, wordt zoveel mogelijk aan de belastingschuldige het feitelijk gebruik gelaten.

Nadat op roerende zaken beslag is gelegd, wordt zoveel mogelijk aan de belastingschuldige het feitelijk gebruik gelaten.

Onder bijzondere omstandigheden kan de belastingdeurwaarder beslagen zaken wegvoeren. Hij stelt daartoe een gerechtelijke bewaarder aan als bedoeld in [Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827). Het aanstellen van een bewaarder ontheft de ontvanger niet van zijn verantwoordelijkheid met betrekking tot de in beslag genomen zaken.

Het wegvoeren van zaken is mogelijk, als dit voor het behoud van die zaken redelijkerwijze noodzakelijk is ([artikel 446 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=446)). Dit is bijvoorbeeld aan de orde als de zaken dreigen te worden verduisterd of beschadigd. Hetzelfde geldt als er gegronde vrees bestaat dat verhaal op de zaken ernstig bemoeilijkt wordt of feitelijk onmogelijk is, indien de zaken niet worden afgevoerd. Bijvoorbeeld als de belastingdeurwaarder administratief beslag als bedoeld in [artikel 442, eerste lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=442), heeft gelegd op een motorrijtuig of een aanhangwagen, en de geëxecuteerde het motorrijtuig of de aanhangwagen niet heeft ingeleverd, nadat de belastingdeurwaarder hem daartoe twee keer in de gelegenheid heeft gesteld.

### 14.2.10. Belasting van personenauto’s en motorrijwielen en belasting zware motorrijtuigen en beslag roerende zaken

Het wegvoeren van zaken, waaronder motorrijtuigen naar aanleiding van een actie op grond van [artikel 18 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=18), gebeurt niet dan na daartoe verkregen toestemming van de directeur van het organisatieonderdeel van de Belastingdienst waar de belastingdeurwaarder die de zaken wil wegvoeren werkzaam is. De toestemming kan ook worden verkregen van de plaatsvervanger van de desbetreffende directeur of van een andere door die directeur of zijn plaatsvervanger daartoe aangewezen functionaris.

Artikel 14.2.9 van deze leidraad is niet van toepassing op naheffingsaanslagen – als bedoeld in [artikel 9, achtste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9) – als de beslaglegging onmiddellijk na het opleggen van de belastingaanslag en de betekening van het dwangbevel plaatsvindt.
...
De ontvanger moet er voor zorgdragen dat geen zilveren, gouden of platina werken die niet zijn voorzien van de stempeltekenen die volgens de [Waarborgwet 2019](https://wetten.overheid.nl/jci1.3:c:BWBR0042284) vereist zijn, in openbare verkoop worden gebracht of met dat doel worden tentoongesteld.

### 14.2.14. Executoriale verkoop zilveren, gouden en platina werken

Van het houden van een openbare verkoop waarin zilveren, gouden of platina werken voorkomen – al dan niet met het vereiste stempelteken – moet de ontvanger aangifte doen zoals [artikel 35 van de Waarborgwet 2019](https://wetten.overheid.nl/jci1.3:c:BWBR0042284&artikel=35) dat voorschrijft.
...
De ontvanger die beslag op de onroerende zaak heeft laten leggen en tevens de huur of pacht wil incasseren, doet hiervoor zoveel mogelijk een vordering ex [artikel 19 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) onder de huurder of pachter. Er wordt in zo’n geval dus niet gehandeld als bedoeld in [artikel 507, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=507).
...
In [artikel 475 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475) en volgende is de mogelijkheid gegeven ten laste van de belastingschuldige beslag te leggen onder een derde. Als blijkt dat – na het afleggen van de buitengerechtelijke verklaring – de derde geen gelden of zaken onder zich heeft, dan blijkt het beslag nooit te hebben gelegen. De ontvanger stelt de derde hiervan op de hoogte.
...
De ontvanger laat geen derdenbeslag leggen onder een zorgaanbieder als bedoeld in [artikel 1 van de Subsidieregeling bonus zorgprofessionals COVID-19](https://wetten.overheid.nl/jci1.3:c:BWBR0044090&artikel=1), voor een bonus die door de zorgaanbieder wordt uitgekeerd aan een zorgprofessional als bedoeld in artikel 1 van de Subsidieregeling bonus zorgprofessionals COVID-19, voor zover aan de zorgaanbieder een subsidie is verstrekt op grond van de [Subsidieregeling bonus zorgprofessionals COVID-19](https://wetten.overheid.nl/jci1.3:c:BWBR0044090). Als reeds beslag is gelegd onder de zorgaanbieder, verzoekt de ontvanger niet om afdracht van de bonus of betaalt de ontvanger de bonus alsnog aan de zorgprofessional uit als de zorgaanbieder de bonus al aan de ontvanger heeft afgedragen.

### 14.4.2. Derdenbeslag of vordering [ex artikel 19](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19)

Als naast een derdenbeslag ook een vordering op grond van [artikel 19 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) mogelijk is, kiest de ontvanger voor het doen van een vordering.
...
Als de belastingschuldige op grond van de basisregistratie personen geen adres in Nederland heeft, stelt de ontvanger bij het leggen van derdenbeslag geen vrij te laten bedrag vast als bedoeld in [artikel 475a, vijfde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475a). Als de belastingschuldige inzicht geeft in zijn leefsituatie en aannemelijk maakt dat hij door het beslag onvoldoende middelen van bestaan overhoudt, kan hij de ontvanger verzoeken alsnog rekening te houden met het voor hem geldende vrij te laten bedrag. De ontvanger stelt in dat geval het voor de leefsituatie van de belastingschuldige geldende vrij te laten bedrag vast. De ontvanger betaalt dat bedrag aan de belastingschuldige, nadat op het derdenbeslag is afgedragen.

### 14.4.5c. Toepassing 5%-regeling

De ontvanger past de zogeheten 5% regeling, bedoeld in [artikel 475dc Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475dc), in beginsel niet toe bij het leggen van derdenbeslag. De ontvanger past die regeling alleen toe als is voldaan aan de voorwaarden van [artikel 19, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) en artikel 19.1.7 of als de ontvanger van mening is dat de belangen van de Staat worden geschaad als hij de 5%-regeling niet toepast.
...
Bij een derdenbeslag op een polis van levens- of spaarverzekering of lijfrente geldt – naast de voorschriften in [artikel 479l Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=479l) en volgende – het volgende:

Bij een derdenbeslag op een polis van levens- of spaarverzekering of lijfrente geldt – naast de voorschriften in [artikel 479l Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=479l) en volgende – het volgende:

### 14.4.10. Retentierecht en derdenbeslag

Als de derde-beslagene een retentierecht heeft op de zaken die door het derdenbeslag van de ontvanger zijn getroffen, dan kan de ontvanger op grond van [artikel 6:30 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0005289&artikel=30) overgaan tot betaling van het bedrag waarvoor het retentierecht geldt in afwachting van verrekening met de belastingschuldige. Het bedrag moet dan wel beduidend lager zijn dan de executiewaarde van de desbetreffende zaak.
...
Als derdenbeslag wordt gelegd onder de Staat of de ontvanger, dan is specificatie verplicht; er wordt in dit verband verwezen naar [artikel 479 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=479).

De verplichting tot specificatie heeft niet tot doel het verhaal te belemmeren, maar de taak van de Staat of de ontvanger te verlichten. Dit betekent dat de verklaring in het kader van het derdenbeslag zich niet moet beperken tot de ex [artikel 479 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=479) genoemde vermogensbestanddelen, maar zich ook moet uitstrekken tot alles wat de geëxecuteerde te vorderen heeft van de Staat of de ontvanger en wat bij de Staat of de ontvanger bekend was op het moment van beslaglegging.
...
In ieder geval zal een minnelijke afdoening moeten passen in het bij [artikel 25](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=25&z=2022-10-01&g=2022-10-01) van deze leidraad geformuleerde uitstelbeleid.
...
Er zijn in deze leidraad op [artikel 15 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=15) geen beleidsregels gemaakt.
...
In aansluiting op [artikel 16 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=16) beschrijft dit artikel het beleid over voor 1 januari 2011 gelegde derdenbeslagen.

### 16.1. Voor 1 januari 2011 gelegde derdenbeslagen

Als vóór 1 januari 2011 onder de ontvanger derdenbeslag op een voorlopige teruggaaf in de inkomstenbelasting met betrekking tot het jaar 2010 is gelegd, geldt het volgende. Dit beslag wordt geacht mede te omvatten een in termijnen uit te betalen bedrag op grond van een voorlopige aanslag in de inkomstenbelasting als bedoeld in [artikel 9, zesde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9) over een volgend jaar voorzover de uit te betalen termijnen van de voorlopige aanslagen op elkaar aansluiten en de schuld waarvoor het beslag is gelegd niet geheel is voldaan. Mutatis mutandis geldt hetzelfde voor een beslag dat is gelegd op een in een of meer termijnen uit te betalen bedrag op grond van een voorschot, als bedoeld in [artikel 22, zevende lid, van de Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&artikel=22).
...
Er zijn in deze leidraad op [artikel 18 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=18) geen beleidsregels gemaakt.

### Artikel 19. Doen van een vordering

In aansluiting op [artikel 19 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) beschrijft dit artikel het beleid over:
...
Bij de toepassing van [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) (het vereenvoudigd beslag op vorderingen van de belastingschuldige op derden) bestaat onder voorwaarden de mogelijkheid een wettelijk beslagverbod gedeeltelijk te negeren. Van deze mogelijkheid maakt de ontvanger alleen gebruik als de belastingschuldige kan worden gekwalificeerd als een notoire wanbetaler in de zin van [artikel 19, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19).
...
De vordering kan niet plaatsvinden voor kinderbijslag onder welke benaming dan ook. In voorkomend geval wordt voor de toepassing van de verruimde beslagmogelijkheid uitgegaan van het maximale bereik: een tiende deel van het bedrag dat op grond van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) niet vatbaar is voor beslag.

### 19.1.6a. Toepassing 5%-regeling

De vordering waarbij een beroep wordt gedaan op de verruimde beslagmogelijkheid vindt steeds separaat plaats en wordt vooraf schriftelijk aangekondigd aan de belastingschuldige, onder vermelding van het bijzondere karakter daarvan.

De ontvanger past de zogeheten 5%-regeling, bedoeld in [artikel 475dc Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475dc), in beginsel niet toe bij het doen van een vordering als bedoeld in [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19). De ontvanger past die regeling alleen toe als is voldaan aan de voorwaarden van artikel 19, tweede lid, van de wet en artikel 19.1.7 of als hij van mening is dat de belangen van de Staat worden geschaad als hij de 5%-regeling niet toepast.

### 19.1.6b. Geen vordering voor corona bonus zorgprofessional

De ontvanger doet geen vordering op grond van [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19), voor een bonus die door een zorgaanbieder als bedoeld in [artikel 1 van de Subsidieregeling bonus zorgprofessionals COVID-19](https://wetten.overheid.nl/jci1.3:c:BWBR0044090&artikel=1) wordt uitgekeerd aan een zorgprofessional als bedoeld in artikel 1 van de Subsidieregeling bonus zorgprofessionals COVID-19, voor zover aan de zorgaanbieder voor de bonus een subsidie is verstrekt op grond van de [Subsidieregeling bonus zorgprofessionals COVID-19](https://wetten.overheid.nl/jci1.3:c:BWBR0044090). Als reeds een vordering is gedaan, is de zorgaanbieder niet verplicht die bonus aan de ontvanger af te dragen, of betaalt de ontvanger de bonus alsnog aan de zorgprofessional uit als de zorgaanbieder de bonus al aan de ontvanger heeft afgedragen.

De ontvanger past de zogeheten 5%-regeling, bedoeld in [artikel 475dc Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475dc), in beginsel niet toe bij het doen van een vordering als bedoeld in [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19). De ontvanger past die regeling alleen toe als is voldaan aan de voorwaarden van artikel 19, tweede lid, van de wet en artikel 19.1.7 of als hij van mening is dat de belangen van de Staat worden geschaad als hij de 5%-regeling niet toepast.

In afwijking in zoverre van [artikel 19, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) vindt de vordering waarbij de doorbreking van een wettelijk beslagverbod wordt ingeroepen slechts plaats indien voldaan is aan de volgende voorwaarden:

### Artikel 19.1.8. Vordering ten laste van de echtgenoot

### Artikel 19.1.8. Vordering ten laste van de echtgenoot

Als de echtgenoot van de belastingschuldige recht heeft op gelden, penningen of een vordering heeft op een derde die in de huwelijksgemeenschap vallen, dan kan de ontvanger een vordering ten laste van de echtgenoot doen. Als de vordering ziet op een belastingschuld die niet tot de gemeenschap behoort, beperkt de ontvanger zijn vordering tot de helft van het voor beslag vatbare deel van de vordering op de derde. Deze beperking geldt niet als de echtgenoot instemt met verhaal op het geheel. De bekendmaking van de vordering dient zo spoedig mogelijk, maar uiterlijk binnen acht dagen na het doen van de vordering, te geschieden aan de belastingschuldige en de echtgenoot afzonderlijk. Voor zover het periodieke uitkeringen betreft die onder de opsomming van [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) vallen, past de ontvanger de beslagvrije voet toe alsof de echtgenoot de belastingschuldige is. Voor zover de vordering wordt gedaan op een vordering die de echtgenoot van de belastingschuldige heeft op een betaaldienstverlener, is het bepaalde in [artikel 1cbis.2 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=1cbis.2) van overeenkomstige toepassing.
...
Voorlopige aanslagen als bedoeld in [artikel 10, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) kan de ontvanger niet eerder aanmelden dan nadat de termijnen die aan die aanslagen verbonden zijn, zijn vervallen. De ontvanger splitst de voorlopige aanslagen naar tijdsevenredigheid.

### 19.2.2. Belastingschulden ontstaan gedurende een surseance zijn boedelschulden in faillissement

Belastingschulden die materieel zijn ontstaan gedurende de periode van een surseance van betaling die aan het faillissement voorafgaat, kunnen op grond van [artikel 249 Fw](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=249) worden beschouwd als boedelschulden in het faillissement.
...
Als een vordering wordt gedaan op periodieke uitkeringen waarvoor geen beslagvrije voet geldt en de belastingschuldige toont aan dat hij voor zijn levensonderhoud volledig afhankelijk is van deze uitkeringen, dan past de ontvanger de [artikelen 475b](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475b) en [475d tot en met 475e Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475d) toe.
...
Als de belastingschuldige buiten Nederland een vaste woon- of verblijfplaats heeft, stelt de ontvanger overeenkomstig [artikel 475da, vierde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475da) de beslagvrije voet vast bij het doen van een vordering op een periodieke uitkering waaraan een beslagvrije voet is verbonden. Na de vooraankondiging van de vordering kan de belastingschuldige door middel van het aanleveren van informatie de ontvanger op de hoogte stellen over zijn leefsituatie en bronnen van inkomsten. Als de belastingschuldige aantoont wat zijn leefsituatie en inkomen is, stelt de ontvanger op basis van de verstrekte informatie de beslagvrije voet vast. Als de belastingschuldige geen inzicht verschaft of onduidelijkheid blijft bestaan over zijn leefsituatie en inkomstenbronnen blijft de ontvanger uitgaan van de beslagvrije voet overeenkomstig artikel 475da, vierde lid, Rv.

Als de ontvanger een vordering doet op een periodieke uitkering waaraan een beslagvrije voet is verbonden, ten laste van een belastingschuldige van wie geen woon- of verblijfadres bekend is, stelt hij de beslagvrije voet vast overeenkomstig [artikel 475da, vierde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475da). Zodra de ontvanger bekend wordt met het feit dat de belastingschuldige in Nederland woont of een vaste verblijfplaats heeft, stelt de ontvanger alsnog de juiste beslagvrije voet vast en past deze toe vanaf de eerstvolgende inhouding, dus zonder terugwerkende kracht. Het laatste geldt niet als de belastingschuldige kan aantonen dat het ontbreken van het adresgegeven niet aan hem te wijten is.
...
Verhaal op (periodieke) inkomsten die een belastingschuldige geniet vanwege de Staat, gebeurt door aan de betreffende autoriteit verrekening te vragen volgens [artikel 117 van de Ambtenarenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0001947&artikel=117) en subsidiair door een vordering te doen.
...
In aansluiting op [artikel 20 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=20) beschrijft dit artikel het beleid over:
...
De tenuitvoerlegging van een dwangbevel door toepassing van lijfsdwang vindt niet eerder plaats dan één dag na de betekening met bevel tot betaling als bedoeld in [artikel 591, eerste lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=591), tenzij de voorzieningenrechter van de rechtbank verlof heeft verleend tot dadelijke tenuitvoerlegging, dan wel sprake is van een situatie als bedoeld in [artikel 15 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=15).
...
Al hetgeen is vermeld in [artikel 20](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=20&z=2024-07-01&g=2024-07-01) van deze leidraad is zoveel mogelijk hierop van overeenkomstige toepassing.

### 20.5. Lijfsdwang in geval van civiele vordering

De ontvanger heeft de bevoegdheid om een dwangbevel ten uitvoer te leggen door middel van lijfsdwang. Naast deze bevoegdheid kan de ontvanger op grond van [artikel 20 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=20) ook lijfsdwang toepassen met betrekking tot civiele vorderingen die strekken tot betaling van schadevergoeding aan de ontvanger in verband met een belastingschuld die niet is voldaan. Al hetgeen is vermeld in [artikel 20](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=20&z=2024-07-01&g=2024-07-01) van deze leidraad is zoveel mogelijk hierop van overeenkomstige toepassing.

De ontvanger heeft de bevoegdheid om een dwangbevel ten uitvoer te leggen door middel van lijfsdwang. Naast deze bevoegdheid kan de ontvanger op grond van [artikel 20 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=20) ook lijfsdwang toepassen met betrekking tot civiele vorderingen die strekken tot betaling van schadevergoeding aan de ontvanger in verband met een belastingschuld die niet is voldaan. Al hetgeen is vermeld in [artikel 20](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=20&z=2023-01-01&g=2023-01-01) van deze leidraad is zoveel mogelijk hierop van overeenkomstige toepassing.

In aansluiting op [artikel 21 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=21) beschrijft dit artikel het beleid over:

### 21.1. Begrippen bodemzaken en bodemvoorrecht

De zaken omschreven in [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) worden verder aangeduid als bodemzaken.

### 21.4. Bodemvoorrecht in faillissement en in de WSNP

Het voorrecht gaat – indien en voor zover het de belastingen genoemd in [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) betreft – boven een pandrecht dat gevestigd is op bodemzaken. Dit voorrecht wordt verder aangeduid als bodemvoorrecht.
...
Op het moment dat de verjaring intreedt – als bepaald in [artikel 27 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=27) – vervalt het fiscale voorrecht.
...
In aansluiting op [artikel 22 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) beschrijft dit artikel het beleid over:

Derden die de eigendom pretenderen van inbeslaggenomen roerende of onroerende zaken, kunnen hun rechten op die zaken – op de voet van [artikel 456 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=456) respectievelijk [538 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=538) en volgende – geldend maken. Op grond van [artikel 435 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) kunnen derden zich ook tegen het beslag verzetten.

### 22.7. Bodemrecht en voorrang

Met derden worden hier niet alleen bedoeld degenen die zich op een eigendomsrecht beroepen, maar ook degenen die een beperkt recht op de zaak menen te hebben. Een tijdig ingediend beroepschrift op de voet van [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) schort de executie van rechtswege op.

[Artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) ontneemt derden de mogelijkheid van verzet in rechte tegen de inbeslagneming van de in dat artikel bedoelde zaken en genoemde belastingaanslagen. Dit noemt men het bodemrecht van de fiscus. Deze beperking biedt de ontvanger de mogelijkheid de belastingschuld te verhalen op de desbetreffende zaken, ook als deze niet aan de belastingschuldige toebehoren.

### 22.4. Volgorde uitwinning bodembeslag buiten faillissement

Voor de toepasselijkheid van [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) is in de eerste plaats beslissend of de aldaar bedoelde zaken op de bodem van de belastingschuldige in beslag genomen worden. Onder bodem wordt verstaan het perceel of het gedeelte van een perceel dat bij de belastingschuldige – voor welk doel dan ook – in gebruik is en waarover hij onafhankelijk van anderen de – feitelijke – beschikking heeft. Bovendien kan er sprake zijn van een gemeenschappelijke bodem als een perceel bij meer dan één natuurlijke en/of rechtspersoon in gebruik is. De uitdrukking ‘stoffering’ heeft in dit verband een zodanig brede betekenis, dat daaronder kan worden verstaan al hetgeen strekt tot gebruik van het perceel overeenkomstig zijn bestemming.

### 22.2. Bodemrecht en bestuurlijke boeten

Het bodemrecht wordt niet toegepast voor de bestuurlijke boeten.

Als de ontvanger bekend is met de omstandigheid dat zaken mogelijk in eigendom toebehoren aan een derde, dan is hij op grond van [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) verplicht bij beslaglegging op die zaken, dit beslag binnen acht dagen na de beslaglegging aan die derde te doen betekenen door de belastingdeurwaarder.
...
In andere gevallen kan de ontvanger in overleg met de derde-eigenaar besluiten om het beslag ex [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) op te heffen tegen zekerheidsstelling. Als de derde daartoe niet bereid is, kan de ontvanger tot verkoop van de bodemzaken overgaan.
...
In [artikel 22 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) is geen bepaling omtrent voorrang opgenomen, maar volgens vaste jurisprudentie kan de ontvanger zich ook bij toepassing van dit artikel op voorrang beroepen.
...
Als uit een verzetschrift ex [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) blijkt dat de derde geen eigenaar is van de zaken genoemd in dat verzetschrift, of voor de ontvanger anderszins duidelijk is dat de derde geen eigenaar is van de betreffende zaken, dan vindt executie van die zaken in beginsel doorgang.

Als uit een verzetschrift ex [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) blijkt dat de derde geen eigenaar is van de zaken genoemd in dat verzetschrift, of voor de ontvanger anderszins duidelijk is dat de derde geen eigenaar is van de betreffende zaken, dan vindt executie van die zaken in beginsel doorgang.

Als de derde een schriftelijke mededeling ex [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) heeft gedaan, heft de ontvanger het beslag op als zonder meer duidelijk is dat het zaken betreft waarop de ontvanger geen verhaal kan nemen.
...
Een verzet op de voet van [artikel 456 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=456) tegen de verkoop van roerende zaken schort de voortgang van de executie niet van rechtswege op.
...
Onverminderd het bepaalde in [artikel 22 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) geldt voor de beroepsfase dat als uit een beroepschrift niet duidelijk blijkt waarop het beroep is gebaseerd, de ontvanger de indiener verzoekt om het beroepschrift binnen een redelijke termijn (nader) te motiveren. De ontvanger wijst de indiener op een mogelijke niet-ontvankelijkverklaring bij het niet voldoen aan de motiveringsplicht.

### 22.8.6. Taak van de ontvanger met betrekking tot beroepschrift ex [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22)
...
De situatie kan zich voordoen dat de ontvanger uit het ingediende bezwaarschrift niet kan opmaken of is beoogd administratief beroep in te stellen op grond van [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) dan wel verzet aan te tekenen op grond van [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435).

Als dat het geval is, nodigt de ontvanger de derde uit zich daarover binnen tien dagen uit te laten. Als de derde niet reageert, wordt het geschrift aangemerkt als een beroepschrift ex [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22).

### 22.8.9. Samenloop administratief beroep en verzet tegen bodembeslag

Als de derde zowel een beroepschrift ex [artikel 22, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) indient als een schriftelijke mededeling doet als bedoeld in [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435), dan zendt de ontvanger eerst het beroepschrift ter behandeling aan de directeur, voordat hij het verzet ex [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) behandelt.
...
In dit verband wordt verwezen naar het [besluit van 15 november 1999](https://wetten.overheid.nl/jci1.3:c:BWBR0010861), nummer AFZ 99/3262M, Stcrt. 225, laatstelijk gewijzigd bij besluit van 10 december 2019, nummer 2019-166072.

In dit verband wordt verwezen naar het [besluit van 15 november 1999](https://wetten.overheid.nl/jci1.3:c:BWBR0010861), nummer AFZ 99/3262M, Stcrt. 225, laatstelijk gewijzigd bij besluit van 10 december 2019, nummer 2019-166072.

Bij de beslissing van de directeur op een beroepschrift dat is ingediend tegen de inbeslagneming van bodemzaken voor belastingaanslagen als bedoeld in [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22), wordt het eigendomsrecht van een derde ontzien in die gevallen waarin sprake is van reëel eigendom van de derde. De executie met toepassing van het bodemrecht van zaken, waarvan de ontvanger weet dat deze niet aan de belastingschuldige toebehoren, maar ten aanzien waarvan geen beroepschrift is ingediend of verzet is gedaan, heeft slechts plaats als zij past in het beleid, dat is verwoord in dit artikel.
...
De lessor zal uitsluitend voor de toepassing van het bodemrecht ex [artikel 22, derde lid, van de Invorderingswet 1990](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22), alsmede voor de toepassing van [artikel 3.30, eerste lid, van de Wet IB 2001](https://wetten.overheid.nl/jci1.3:c:BWBR0011353&artikel=3.30) en de investeringsfaciliteiten in ieder geval als eigenaar van een door hem op basis van leasing ter beschikking gesteld leaseobject worden aangemerkt indien hij:
...
In aansluiting op [artikel 22bis van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22bis) beschrijft dit artikel het beleid over:

### Artikel 22a. Bijzonder verhaalsrecht in relatie tot autoverhuurbedrijven en leasemaatschappijen

In aansluiting op [artikel 22a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22a) beschrijft dit artikel het beleid over het bijzondere verhaalsrecht in relatie tot autoverhuurbedrijven en leasemaatschappijen.

### Artikel 22a. Bijzonder verhaalsrecht in relatie tot autoverhuurbedrijven en leasemaatschappijen

In aansluiting op [artikel 22a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22a) beschrijft dit artikel het beleid over het bijzondere verhaalsrecht in relatie tot autoverhuurbedrijven en leasemaatschappijen.

Motorrijtuigen die toebehoren aan autoverhuurbedrijven of leasemaatschappijen zullen in beginsel geen voorwerp zijn van het bijzondere verhaalsrecht van [artikel 22a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22a). Dit is slechts anders als sprake is van misbruik of als de belasting die betrekking heeft op het betreffende motorrijtuig niet is betaald. In het laatste geval blijft de toepassing van het verhaalsrecht beperkt tot die belasting.

Motorrijtuigen die toebehoren aan autoverhuurbedrijven of leasemaatschappijen zullen in beginsel geen voorwerp zijn van het bijzondere verhaalsrecht van [artikel 22a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22a). Dit is slechts anders als sprake is van misbruik of als de belasting die betrekking heeft op het betreffende motorrijtuig niet is betaald. In het laatste geval blijft de toepassing van het verhaalsrecht beperkt tot die belasting.

### Artikel 23

Er zijn in deze leidraad op [artikel 23 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=23) geen beleidsregels gemaakt.
...
Ondanks het feit dat de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) daartoe wel de mogelijkheid biedt, worden uit te betalen bedragen niet automatisch verrekend met aanslagen die (nog) niet invorderbaar zijn. Dit laat onverlet dat de ontvanger bevoegd is om in daartoe aanleiding gevende gevallen binnen de betalingstermijn te verrekenen.

### 24.5. Verrekening en fiscale eenheid vennootschapsbelasting

Hierop maakt de ontvanger een uitzondering als er sprake is van een situatie als bedoeld in [artikel 10, eerste lid, onderdelen b, c of d, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10). Dan is verrekening mogelijk met alle termijnen van de voorlopige aanslag vanaf het moment dat zich één van de genoemde situaties voordoet.
...
### 24.3a. Verrekening teruggaaf [artikel 29, eerste lid, Wet op de omzetbelasting](https://wetten.overheid.nl/jci1.3:c:BWBR0002629&artikel=29)

Een belastingteruggaaf op grond van [artikel 29, eerste lid, van de Wet op de omzetbelasting 1968](https://wetten.overheid.nl/jci1.3:c:BWBR0002629&artikel=29) kan worden verrekend met belastingschuld van de belastingschuldige die materieel is ontstaan voor de datum van zijn faillissement.
...
Als verliezen die zijn ontstaan tijdens het bestaan van de fiscale eenheid, worden teruggewenteld naar perioden die zijn gelegen vóór het begin van de bestaansperiode, dan vallen de teruggaven buiten de bestaansduur van de fiscale eenheid. Dit neemt niet weg dat verrekening mogelijk is op de voet van [artikel 24 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=24) als het om dezelfde belastingschuldige gaat.
...
In [artikel 24, vierde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=24) is een instemmingsregeling opgenomen die verrekening uitsluit als de ontvanger instemt met cessie ([artikel 3:94 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0005291&artikel=94)) of stille verpanding ([artikel 3:239 BW](https://wetten.overheid.nl/jci1.3:c:BWBR0005291&artikel=239)) van een uit te betalen bedrag.
...
### 24.6.4. Beroepsprocedure weigeren instemming cessie of verpanding en [Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537)

Onverminderd het bepaalde in [artikel 24 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=24) geldt met betrekking tot een beroepschrift waaruit niet direct duidelijk blijkt waarop het beroep is gebaseerd, dat de ontvanger de indiener verzoekt het beroepschrift binnen een redelijke termijn (nader) te motiveren. De ontvanger wijst de indiener op een mogelijke niet-ontvankelijkverklaring bij het niet voldoen aan deze motiveringsplicht.
...
In aansluiting op [artikel 25 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=25) beschrijft dit artikel het beleid over:
...
Voor een aanslag die uitsluitend wordt opgelegd met het doel de bevoegdheid tot het vaststellen van een aanslag te behouden – een en ander als bedoeld in [artikel 11, derde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0002320&artikel=11), [artikel 16, derde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0002320&artikel=16), en [artikel 20, derde lid, van de AWR](https://wetten.overheid.nl/jci1.3:c:BWBR0002320&artikel=20) – verleent de ontvanger ambtshalve uitstel van betaling. Het uitstel wordt verleend voor het gehele bedrag van de aanslag en duurt tot het moment waarop de inspecteur de belastingplichtige de precieze elementen van de aanslag heeft meegedeeld.
...
Voor mogelijke rentecorrecties in verband met overlegprocedures zie [artikel 31a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=31a).
...
De betalingscapaciteit bestaat uit het netto besteedbaar inkomen na aftrek van het normbedrag voor levensonderhoud. Voor de betalingsregeling eist de ontvanger 80% van de betalingscapaciteit op. Voor een belastingschuldige die in het buitenland woont, past de ontvanger op het normbedrag voor levensonderhoud eerst het percentage toe dat in [artikel 1 van de Regeling woonlandbeginsel in de sociale zekerheid 2012](https://wetten.overheid.nl/jci1.3:c:BWBR0031508&artikel=1) en de [bijlage bij die regeling](onbekend) is opgenomen voor het woonland van de belastingschuldige. Eventuele periodieke inkomsten die de belastingschuldige uit zijn woonland geniet, telt de ontvanger op bij de aldus berekende betalingscapaciteit.
...
Als de belastingschuldige het niet eens is met een door de ontvanger genomen beslissing op grond van [artikel 25, eerste lid of tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=25), kan de belastingschuldige daartegen administratief beroep instellen bij de directeur. De belastingschuldige moet het beroepschrift indienen bij de ontvanger die de beschikking heeft genomen.
...
In aansluiting op [artikel 25a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=25a) beschrijft dit artikel het beleid over de zekerheid die de ontvanger verlangt bij het verlenen van uitstel van betaling ter zake van exitheffingen.
...
In aansluiting op [artikel 26 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=26) beschrijft dit artikel het beleid over:
...
De termijn van veertien dagen geldt niet als sprake is van een situatie als bedoeld in [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10). De termijn wordt daarnaast niet of niet geheel verleend als naar het oordeel van de ontvanger aanwijzingen bestaan dat door het niet direct aanvangen of vervolgen van de invordering de belangen van de Staat worden geschaad.
...
Als de belastingschuldige een energietoeslag heeft ontvangen als bedoeld in [artikel 35, vierde of vijfde lid, Pw](https://wetten.overheid.nl/jci1.3:c:BWBR0015703&artikel=35), wordt een bedrag ter hoogte van het ontvangen bedrag aan energietoeslag, niet in aanmerking genomen als vermogen voor de beoordeling van het recht op kwijtschelding.
...
Bij de berekening van het netto besteedbare inkomen wordt rekening gehouden met inkomsten die studenten ontvangen op grond van de [WSF](https://wetten.overheid.nl/jci1.3:c:BWBR0011453) en [hoofdstuk 4 van de Wet tegemoetkoming onderwijsbijdrage en schoolkosten](https://wetten.overheid.nl/jci1.3:c:BWBR0012438&hoofdstuk=4) (WTOS VO-18+).
...
Als het verzoek om kwijtschelding wordt gedaan voor belastingschulden die zijn ontstaan voor de aanvang van de huwelijkse periode, dan wel de gezamenlijke huishouding in de zin van [artikel 3 Pw](https://wetten.overheid.nl/jci1.3:c:BWBR0015703&artikel=3) (zie artikel 26.2.10 van deze leidraad), worden de woonlasten in aanmerking genomen tot ten hoogste 50% van het bedrag dat de uitkomst is van de berekening op grond van [artikel 15, eerste lid, onderdeel b, van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=15).

Naast de alimentatieverplichtingen wordt bij de berekening van het netto besteedbaar inkomen de daadwerkelijk betaalde onderhoudsbijdrage – de bijdrage die een gemeente op grond van de [Pw](https://wetten.overheid.nl/jci1.3:c:BWBR0015703) van een ex-partner vordert in de kosten van bijstand – in mindering gebracht.
...
De normpremie, bedoeld in [artikel 2 van de Wet op de zorgtoeslag](https://wetten.overheid.nl/jci1.3:c:BWBR0018451&artikel=2), voor zover is begrepen in de bijstandsnorm, bedraagt voor een alleenstaande of een alleenstaande ouder € 42 per maand en voor echtgenoten € 95 per maand.
...
In aanvulling van [artikel 22 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=22) werkt de ontvanger uitsluitend mee aan een saneringsakkoord als de communautaire middelen volledig worden voldaan.
...
De ontvanger betrekt rente en kosten integraal in het akkoord. Het bedrag dat op basis van het akkoord is betaald, wordt in afwijking van [artikel 7 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7) op de hoofdsom afgeboekt. De ontvanger vermeldt dit in de beschikking.
...
Als binnen de termijn van tien dagen als bedoeld in [artikel 24 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=24) een beroepschrift wordt ingediend, dan wordt gedurende de behandeling van dit beroepschrift gehandeld overeenkomstig [artikel 9 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=9).
...
In aansluiting op [artikel 27a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=27a) beschrijft dit artikel het beleid over de verlening van betalingskorting bij vermindering van de belastingaanslag.
...
Kwijtschelding van uitsluitend invorderingsrente is niet mogelijk. De ontvanger doet ook geen toezegging dat de rente niet zal worden ingevorderd. Dit laat onverlet dat de ontvanger kwijtschelding verleent of rente buiten invordering laat, als hij de hoofdsom kwijtscheldt of buiten invordering laat op grond van het bepaalde in [artikel 26](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=26&z=2023-01-01&g=2022-10-01) van deze leidraad.
...
Kwijtschelding van uitsluitend invorderingsrente is niet mogelijk. De ontvanger doet ook geen toezegging dat de rente niet zal worden ingevorderd. Dit laat onverlet dat de ontvanger kwijtschelding verleent of rente buiten invordering laat, als hij de hoofdsom kwijtscheldt of buiten invordering laat op grond van het bepaalde in [artikel 26](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=26&z=2023-01-01&g=2023-01-01) van deze leidraad.
...
Er zijn in deze leidraad op [artikel 28a](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=28a) en [artikel 28b van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=28b) geen beleidsregels gemaakt.
...
Als om uitstel van betaling wordt verzocht voor een teruggenomen betalingskorting is het beleid van [artikel 25](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=25&z=2024-07-01&g=2024-07-01) van deze leidraad van overeenkomstige toepassing. Hiervan kan sprake zijn als de ontvanger de teruggenomen betalingskorting bij vergissing niet heeft verrekend met het uit te betalen bedrag van de vermindering.
...
Er zijn in deze leidraad op [artikel 33a van de wet](onbekend) geen beleidsregels gemaakt.
...
De inlener van uitzendondernemingen die voldoen aan de voorwaarden opgenomen in artikel 34.6.1 of 34.6.2 van deze leidraad, heeft automatisch recht op disculpatie van [artikel 34, vijfde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=34).
...
De berekening van de verschuldigde premies werknemersverzekeringen en de inkomensafhankelijke bijdrage [Zorgverzekeringswet](https://wetten.overheid.nl/jci1.3:c:BWBR0018450) vindt plaats alsof de identiteit van de arbeidskrachten waarvoor de inlener om matiging verzoekt op het moment van inhouding vaststond. De uitkomst van die berekening vormt het bedrag waarvoor de inlener na matiging aansprakelijk gesteld kan worden.
...
De aannemer is aansprakelijk voor de loonbelasting en premie volksverzekeringen die met toepassing van het anoniementarief (ex [artikel 26b van de Wet op de loonbelasting 1964](https://wetten.overheid.nl/jci1.3:c:BWBR0002471&artikel=26b)) zijn berekend en door zijn onderaannemer over het werk zijn verschuldigd. Dit geldt ook voor de premies werknemersverzekeringen en de inkomensafhankelijke bijdrage [Zorgverzekeringswet](https://wetten.overheid.nl/jci1.3:c:BWBR0018450) die zonder toepassing van het maximumpremieloon, respectievelijk het maximumbijdrageloon zijn berekend.
...
De berekening van de verschuldigde premies werknemersverzekeringen en de inkomensafhankelijke bijdrage [Zorgverzekeringswet](https://wetten.overheid.nl/jci1.3:c:BWBR0018450) vindt plaats alsof de identiteit van de werknemers waarvoor de aannemer om matiging verzoekt op het moment van inhouding vaststond. De uitkomst van die berekening vormt het bedrag waarvoor de aannemer na matiging aansprakelijk gesteld kan worden.
...
Bij de beoordeling of sprake is van betalingsonmacht speelt het begrip ‘liquide middelen’ een rol. Voor de toepassing van [artikel 36, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=36) worden onder liquide middelen verstaan de kasmiddelen, waaronder de banktegoeden, en de direct opneembare kredietruimte van het lichaam. De melding van betalingsonmacht dient schriftelijk te geschieden door de bestuurder of de gemachtigde van de belastingschuldige. De wijze waarop de schriftelijke melding moet plaatsvinden, is vormvrij. [Artikel 7, derde lid, van het besluit](https://wetten.overheid.nl/jci1.3:c:BWBR0004772&artikel=7) is echter onverminderd van toepassing. Voor de melding kan gebruik worden gemaakt van het formulier dat de Belastingdienst in het zogenoemde Persoonlijk Domein van de belastingschuldige beschikbaar stelt.
...
In [artikel 2, eerste lid, onderdeel g, van de Wet op de vennootschapsbelasting 1969](https://wetten.overheid.nl/jci1.3:c:BWBR0002672&artikel=2) is bepaald dat publiekrechtelijke rechtspersonen, niet zijnde de Staat, zijn onderworpen aan de vennootschapsbelasting voor zover zij een onderneming drijven. De bestuurders van een dergelijke rechtspersoon vallen dus onder de werking van [artikel 36 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=36). De aansprakelijkheid beperkt zich tot de in artikel 36, eerste lid, van de wet genoemde belastingen die de publiekrechtelijke rechtspersoon verschuldigd is ter zake van de ondernemingsactiviteiten.
...
Er zijn in deze leidraad op [artikel 39 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=39) geen beleidsregels gemaakt.
...
Er zijn in deze leidraad op [artikel 41 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=41) geen beleidsregels gemaakt.
...
### Artikel 42a. en [42c](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=42a)
...
In aansluiting op [artikel 42d van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=42d) beschrijft dit artikel het beleid over aansprakelijkheid bij verhaal op de in de verkoopprijs begrepen omzetbelasting.
...
Er zijn in deze leidraad op [artikel 44b van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=44b) geen beleidsregels gemaakt.
...
In aansluiting op [artikel 53 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=53) beschrijft dit artikel het beleid over:
...
De ontvanger verleent geen ontslag van betalingsverplichting als sprake is van verwijtbaarheid van de kant van de aansprakelijk gestelde. Dit volgt uit [artikel 8, eerste lid, onderdeel a, van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=8). De vraag of sprake is van verwijtbaarheid beoordeelt de ontvanger op basis van gedragingen van de aansprakelijk gestelde. Dit betekent dat als de aansprakelijkstelling van een bestuurder is gebaseerd op [artikel 36, vierde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=36), het enkele feit dat het lichaam niet op de juiste wijze heeft gemeld niet in de weg hoeft te staan aan ontslag van betalingsverplichting.

### Artikel 54. Mededeling aan de aansprakelijkgestelde

In aansluiting op [artikel 54 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=54) beschrijft dit artikel het beleid over het aanhouden van de betaling van een teruggaaf bij aansprakelijkstelling.
...
Als de gegevens ook na herhaald verzoek niet voldoen aan de gestelde eisen, beoordeelt de ontvanger of hij een civiele procedure begint of de strafsancties van [Hoofdstuk VIII van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&hoofdstuk=VIII) toepast. Aan de belastingschuldige die niet voldoet aan de verplichting van [artikel 60, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=60), kan de ontvanger een verzuimboete als bedoeld in [artikel 63b, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63b) opleggen.
...
Er zijn in deze leidraad op [artikel 62a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=62a) geen beleidsregels gemaakt.

Er zijn in deze leidraad op [artikel 62bis van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=62bis) geen beleidsregels gemaakt.

Er zijn in deze leidraad op de [artikelen 63](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63), [63a](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63a), [63aa](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63aa) en [63ab](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63ab) van de wet geen beleidsregels gemaakt.

### Artikel 63b. Bestuurlijke boeten

In aansluiting op [artikel 63b van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63b) beschrijft dit artikel het beleid over:

Er zijn in deze leidraad op de [artikelen 63](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63), [63a](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63a), [63aa](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63aa) en [63ab](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63ab) van de wet geen beleidsregels gemaakt.

Bij het opleggen van bestuurlijke verzuimboeten op grond van [hoofdstuk VIIA van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&hoofdstuk=VIIa) zijn, naast de bepalingen van de AWR die in [artikelen 63b van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63b) worden genoemd, de voorschriften van [titel 5.1](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&titeldeel=5.1) en [titel 5.4 van de Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&titeldeel=5.4) van toepassing. Ook zijn de algemene bepalingen in [hoofdstuk 1 van het Besluit Bestuurlijke Boeten Belastingdienst](https://wetten.overheid.nl/jci1.3:c:BWBR0029297&hoofdstuk=1) van toepassing, voor zover deze een invulling geven aan het geldende wettelijke kader.
...
Ter zake van het verzuim als bedoeld in [artikel 63b, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63b) kan de ontvanger een verzuimboete opleggen van 50 procent van het in dat artikel genoemde wettelijk maximum. In afwijking hiervan kan in uitzonderlijke gevallen een boete tot het in artikel 63b, tweede lid, van de wet genoemde maximum worden opgelegd.

### Artikel 63c. en [64](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=64)

De beschikking waarbij de verzuimboete wordt opgelegd kan, maar behoeft niet gelijktijdig met een eventuele (ambtshalve) beslissing te worden genomen.

### Artikel 63c. en [64](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=64)

Er zijn in deze leidraad op de [artikelen 63c](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63c) en [64 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=64) geen beleidsregels gemaakt.
...
Er zijn in deze leidraad op [artikel 67a van de wet](onbekend) geen beleidsregels gemaakt.

In aansluiting op [artikel 70cc van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70cc) beschrijft dit artikel het beleid over de disculpatiemogelijkheid van de bestuurder.

### Artikel 70cc.1. Disculpatiemogelijkheid aansprakelijkheid bestuurder voor vennootschapsbelasting tot 1 april 2017

Voor vennootschapsbelasting die een lichaam is verschuldigd op grond van het tot 1 april 2017 geldende [artikel 23a van de Wet op de vennootschapsbelasting](https://wetten.overheid.nl/jci1.3:c:BWBR0002672&artikel=23a), is de bestuurder niet aansprakelijk als hij bewijst dat:
...
Er zijn in deze leidraad op de [artikelen 70d](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70d), [70e](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70e), [70ea](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70ea), [70f](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70f), [71](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=71) en [72 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=72) geen beleidsregels gemaakt.
...
### 73.2.2. De [WSNP](https://wetten.overheid.nl/jci1.3:c:BWBR0009730) is beëindigd met een schone lei
...
### 73.2.3. De [WSNP](https://wetten.overheid.nl/jci1.3:c:BWBR0009730) is beëindigd zonder schone lei of de schone lei is ingetrokken
...
Als een schuldsaneringsregeling tussentijds wordt beëindigd in de zin van [artikel 350, vijfde lid, Fw](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=350), blijft omzetting in faillissement achterwege als er geen baten beschikbaar zijn. In die situatie geldt het invorderingsbeleid voor natuurlijke personen bij opheffing van een faillissement wegens gebrek aan baten (artikel 73.4.14).
...
Als de ontvanger instemt met een akkoord als bedoeld in [artikel 370, eerste lid, FW](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=370), verleent hij kwijtschelding voor het deel van de belastingschuld dat onbetaald blijft, nadat het akkoord tot stand is gekomen dan wel is gehomologeerd en hij het bedrag dat hem op grond van het akkoord toekomt, heeft ontvangen.
...
Het beleid in deze leidraad en in de regeling dat ziet op kwijtschelding van belastingen is ook van toepassing op een verzoek om instemming met een akkoord als bedoeld in [artikel 370, eerste lid, FW](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=370), tenzij daarvan wordt afgeweken in de volgende artikelen.
...
Voor akkoorden die in het kader van de WHOA ([artikel 370, eerste lid, FW](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=370)) aan de ontvanger worden aangeboden, betekent dit dat de ontvanger daarmee in kan stemmen, als het door hem te ontvangen deel van de belastingschuld ten minste hetzelfde percentage bedraagt als hetgeen aan concurrente crediteuren die in het akkoord zijn betrokken, op hun vorderingen wordt aangeboden. Bij de beoordeling van het akkoord houdt de ontvanger rekening met de zogenoemde 20%-regel als bedoeld in [artikel 374, tweede lid, FW](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=374). De ontvanger kan daardoor onder omstandigheden ook medewerking verlenen aan een akkoord als bedoeld in artikel 370 FW, ondanks dat hij niet ten minste hetzelfde percentage ontvangt als hetgeen aan concurrente crediteuren als bedoeld in artikel 374, tweede lid, FW, op hun vorderingen zal worden uitgekeerd.
...
Als een akkoord als bedoeld in [artikel 370, eerste lid, FW](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=370), waarmee de ontvanger niet heeft ingestemd, door de rechtbank wordt gehomologeerd, verleent de ontvanger voor het resterende deel van de belastingaanslagen geen kwijtschelding maar neemt hij geen verdere invorderingsmaatregelen.
...
Als de ontvanger uitstel van betaling heeft verleend voor de periode van de MSNP, wordt een schriftelijke kennisgeving van de schuldhulpverlener na afloop van de overeenkomst tot schuldregeling aangemerkt als het aanbieden van een buitengerechtelijk akkoord in de zin van [artikel 19a van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=19a) of [artikel 22a van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=22a).
...
Gedurende een door de rechtbank afgekondigde afkoelingsperiode als bedoeld in [artikel 5 van de Wet gemeentelijke schuldhulpverlening](https://wetten.overheid.nl/jci1.3:c:BWBR0031331&artikel=5), schort de ontvanger lopende invorderingsmaatregelen op. Verrekeningen met belastingteruggaven vinden gedurende de afkoelingsperiode niet plaats, ongeacht de periode waarin die teruggaaf is ontstaan. De afkoelingsperiode is niet van invloed op een eventueel verleend uitstel van betaling of een voorwaardelijk verleende kwijtschelding. Hierop blijft het in deze leidraad opgenomen beleid op de [artikelen 25](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=25) en [26 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=26) van toepassing. Gedurende de afkoelingsperiode schort de ontvanger de uitbetaling aan een derde op in verband met een executoriaal beslag op belastingteruggaven van de belastingschuldige.

Indien een akkoord op grond van [artikel 22a van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=22a) niet mogelijk is, vindt kwijtschelding voor ondernemers uitsluitend plaats bij een zogenoemd saneringsakkoord in de zin van [artikel 22 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=22). Zie ook artikel 26.3 van deze leidraad.
...
Voor zover de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) hierop van toepassing is – en uit het zinsverband niet anders volgt – strekken de beleidsvoorschriften zich dus ook uit tot die premies en vorderingen, tenzij uit aanwijzingen van derden voor wie de Belastingdienst invordert anders volgt.
...
Dit laatste zal slechts bij hoge uitzondering aan de orde zijn. Het afwijken van beleidsregels leidt in de regel immers tot schending van het gelijkheidsbeginsel. Er moet dus sprake zijn van daadwerkelijk bijzondere omstandigheden op grond waarvan onverkorte toepassing van de leidraad onevenredig nadeel voor de betrokkene zou opleveren. Dit criterium gaat aanzienlijk verder dan een belangenafweging als bedoeld in [artikel 3:4 Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=3:4).

### 1.1.6. Keuze uit verschillende invorderingsmaatregelen

Toepassing van [artikel 4:84 Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=4:84) zal slechts bij hoge uitzondering aan de orde zijn. Het afwijken van beleidsregels leidt in de regel immers tot schending van het gelijkheidsbeginsel. Er moet dus sprake zijn van daadwerkelijk bijzondere omstandigheden waardoor onverkorte toepassing van de beleidsregels onevenredig nadeel voor de betrokkene zou opleveren. Dit criterium gaat aanzienlijk verder dan een belangenafweging als bedoeld in [artikel 3:4 Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=3:4).
...
Deze terughoudendheid geldt bij ondernemers slechts voor zover sprake is van invorderingsmaatregelen die betrekking hebben op bezittingen die tot de privésfeer kunnen worden gerekend. De terughoudendheid geldt niet als de ontvanger een naheffingsaanslag als bedoeld in [artikel 9, achtste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=9) terstond invordert.
...
De leiding van de invordering berust steeds in handen van de ontvanger. Dit brengt met zich mee dat de belastingdeurwaarder de bevoegdheden die hij rechtstreeks ontleent aan de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770) en aan het [Wetboek van Burgerlijke Rechtsvordering](https://wetten.overheid.nl/jci1.3:c:BWBR0001827), slechts uitoefent nadat hij daartoe een opdracht van de ontvanger heeft verkregen en zich bij de uitoefening van die bevoegdheden houdt aan diens aanwijzingen.
...
Als het gaat om de betekening van stukken of om andere handelingen overeenkomstig het [Wetboek van Burgerlijke Rechtsvordering](https://wetten.overheid.nl/jci1.3:c:BWBR0001827), sluit de ontvanger aan bij het begrip ‘woonplaats’ als bedoeld in de [artikelen 1:10 en volgende van het BW](https://wetten.overheid.nl/jci1.3:c:BWBR0002656&artikel=10).
...
### 6.1. Rente en kosten in het kader van de reikwijdte van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770)

Onder rente als bedoeld in [artikel 6 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=6) wordt alleen verstaan: de invorderingsrente.

### 6.1. Rente en kosten in het kader van de reikwijdte van de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770)

Onder kosten wordt verstaan: alle kosten die op de voet van de [Kostenwet invordering rijksbelastingen](https://wetten.overheid.nl/jci1.3:c:BWBR0002645) aan de belastingschuldige in rekening worden gebracht. Hieronder vallen ook de kosten die zijn verbonden aan de werkzaamheden die de belastingdeurwaarder verricht bij de invordering langs civielrechtelijke weg.

### Artikel 7. Betaling en afboeking

In aansluiting op [artikel 7 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=7) beschrijft dit artikel het beleid over:
...
Als betekening ten aanzien van de gezamenlijke erfgenamen van een overledene op de voet van [artikel 53 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=53) niet mogelijk of niet wenselijk is, dan vermeldt de ontvanger alle erfgenamen met naam en adres alsmede met hun kwaliteit van erfgenaam van de overleden belastingschuldige in het dwangbevel. De ontvanger brengt daarbij evenwel niet het deel van ieders aansprakelijkheid tot uitdrukking.
...
Als de derde een dergelijk beroep doet nadat het exploot van beslag op roerende zaken is afgesloten, legt de belastingdeurwaarder geen afzonderlijk derdenbeslag maar geldt het beslag roerende zaken als derdenbeslag. De belastingdeurwaarder betekent in dat geval een formulier als bedoeld in [artikel 475, tweede lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475), binnen drie dagen nadat de derde zich erop heeft beroepen dat hij het beslag niet behoeft te dulden.
...
De ontvanger verhaalt de openstaande schuld waarvoor het beslag roerende zaken is gelegd op de executieopbrengst, inclusief de daarin begrepen omzetbelasting. Voordat de opbrengst op de openstaande schuld wordt afgeboekt, worden eerst de kosten van executie verrekend. De ontvanger boekt de opbrengst vervolgens af met inachtneming van het bepaalde bij [artikel 7](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=7&z=2024-07-01&g=2024-07-01) van deze leidraad.
...
In ieder geval zal een minnelijke afdoening moeten passen in het bij [artikel 25](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=25&z=2024-07-01&g=2024-07-01) van deze leidraad geformuleerde uitstelbeleid.
...
In aansluiting op [artikel 17 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=17) beschrijft dit artikel het beleid over:
...
Bij de toepassing van [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) (het vereenvoudigd beslag op vorderingen van de belastingschuldige op derden) bestaat onder voorwaarden de mogelijkheid een wettelijk beslagverbod gedeeltelijk te negeren.

### 19.1.6a. Toepassing 5%-regeling

De ontvanger zal de zogeheten 5% regeling niet gelijktijdig toepassen met de regeling, bedoeld in [artikel 19, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19).
...
### 19.3.6. Verrekening ex [artikel 117 Ambtenarenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0001947&artikel=117)
...
In dat geval moet worden nagegaan wat de periodieke inkomsten van de belastingschuldige en zijn partner per maand zijn. De belastingschuldige is verplicht zowel zijn inkomsten als die van zijn gezinsleden op te geven (vergelijk [artikel 475g Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=475g) met artikel 19.3.4 van deze leidraad).
...
Ook op grond van [artikel 4:124 van de Algemene wet bestuursrecht](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=4:124) is lijfsdwang mogelijk, namelijk wanneer een vonnis als bedoeld in [artikel 585 Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=585) is verkregen ten laste van een belastingschuldige dan wel een derde.

### 20.5. Lijfsdwang in geval van civiele vordering

Al hetgeen is vermeld in [artikel 20](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=20&z=2023-01-01&g=2023-01-01) van deze leidraad is zoveel mogelijk hierop van overeenkomstige toepassing.
...
In een faillissementssituatie heft de ontvanger het met toepassing van het bodemrecht gelegd beslag ex [artikel 22, derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) op, als mocht blijken dat het vrije boedelactief tezamen met de te verwachten verkoopopbrengst van de verpande bodemzaken ex [artikel 21, tweede lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=21) van zodanige omvang is, dat daaruit de belastingschuld zal worden voldaan.
...
Het beroepschrift ex [artikel 22 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22) moet worden ingediend bij de ontvanger, waaronder de belastingschuldige ressorteert. Een beroepschrift kan niet meer worden ingediend als het beslag is opgeheven of vervallen.
...
In [artikel 24, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=24) is geregeld dat de ontvanger alle in te vorderen en uit te betalen bedragen van alle onderdelen van een fiscale eenheid voor de vennootschapsbelasting onderling kan verrekenen.
...
De ontvanger verleent geen ambtshalve uitstel als bedoeld in de eerste alinea als zich een situatie voordoet zoals omschreven in [artikel 10 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=10) en de ontvanger van mening is dat de verhaalbaarheid van de belastingschuld ernstig in gevaar komt.
...
In aansluiting op [artikel 25b van de wet](onbekend) beschrijft dit artikel het beleid over de zekerheid die de ontvanger verlangt bij het verlenen van uitstel van betaling ter zake van exitheffingen als aannemelijk is dat gegronde vrees bestaat dat de belastingschuld niet kan worden verhaald.
...
De normpremie, bedoeld in [artikel 2 van de Wet op de zorgtoeslag](https://wetten.overheid.nl/jci1.3:c:BWBR0018451&artikel=2), voor zover is begrepen in de bijstandsnorm, bedraagt voor een alleenstaande of een alleenstaande ouder € 34 per maand en voor echtgenoten € 79 per maand.
...
De hier te lande alleenwonende gehuwde belastingschuldige die zijn in het buitenland verblijvende echtgenote en/of kinderen daadwerkelijk onderhoudt, wordt voor de berekening van de betalingscapaciteit niet als een alleenstaande aangemerkt. Uitgegaan wordt van het normbedrag voor echtgenoten in de zin van [artikel 3 Pw](https://wetten.overheid.nl/jci1.3:c:BWBR0015703&artikel=3). Als huur wordt de hier te lande betaalde huur in aanmerking genomen. Door toepassing van het normbedrag voor echtgenoten in de zin van [artikel 3 Pw](https://wetten.overheid.nl/jci1.3:c:BWBR0015703&artikel=3), wordt in het kwijtscheldingsbeleid op forfaitaire wijze rekening gehouden met de bedragen die de buitenlandse werknemer aan zijn bloed- of aanverwanten overmaakt voor de kosten van levensonderhoud. Met de werkelijke bedragen die de buitenlandse belastingschuldige overmaakt, wordt geen rekening gehouden.
...
Voor een saneringsakkoord als bedoeld in [artikel 21 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=21) (zie ook artikel 26.3.1) betekent dit dat de ontvanger daarmee in kan stemmen, als het door hem te ontvangen deel van de belastingschuld, ten minste hetzelfde percentage bedraagt als hetgeen aan concurrente crediteuren die in het akkoord zijn betrokken, op hun vorderingen wordt aangeboden. Dit is van overeenkomstige toepassing in de situatie bedoeld in artikel 26.3.8, tweede gedachtestreepje.
...
In aansluiting op [afdeling 4.4.3.van de Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&afdeling=4.4.3) en [artikel 27 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=27) beschrijft dit artikel het beleid over:
...
Kwijtschelding van uitsluitend invorderingsrente is niet mogelijk. De ontvanger doet ook geen toezegging dat de rente niet zal worden ingevorderd. Dit laat onverlet dat de ontvanger kwijtschelding verleent of rente buiten invordering laat, als hij de hoofdsom kwijtscheldt of buiten invordering laat op grond van het bepaalde in [artikel 26](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=26&z=2024-01-01&g=2024-01-01) van deze leidraad.

### 28.5. Rente- of schadevergoeding

Kwijtschelding van uitsluitend invorderingsrente is niet mogelijk. De ontvanger doet ook geen toezegging dat de rente niet zal worden ingevorderd. Dit laat onverlet dat de ontvanger kwijtschelding verleent of rente buiten invordering laat, als hij de hoofdsom kwijtscheldt of buiten invordering laat op grond van het bepaalde in [artikel 26](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=26&z=2024-07-01&g=2024-07-01) van deze leidraad.
...
Naast deze voorwaarden op grond van [artikel 6, eerste lid, van de Uitvoeringsregeling inleners-, keten- en opdrachtgeversaansprakelijkheid 2004](https://wetten.overheid.nl/jci1.3:c:BWBR0016131&artikel=6), moet de inlener
...
Als het winkelbedrijf in de hoedanigheid van opdrachtgever aansprakelijk kan worden gesteld, (zie [artikel 35a, aanhef](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=35a&z=2024-01-01&g=2024-01-01), van deze leidraad) blijft een aansprakelijkstelling op grond van het zogenoemde eigenbouwerschap ex [artikel 35, derde lid, onderdeel b, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=35) achterwege.
...
Onder het begrip betalingsonmacht moet worden verstaan de omstandigheid dat het lichaam voor zijn belastingen als bedoeld in [artikel 36, tweede lid van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=36):
...
[Hoofdstuk III van het besluit](https://wetten.overheid.nl/jci1.3:c:BWBR0004772&hoofdstuk=III) regelt binnen welke termijn de belastingschuldige de betalingsonmacht aan de ontvanger moet melden. Voor de beantwoording van de vraag of de per post verzonden schriftelijke melding de ontvanger tijdig heeft bereikt, wordt aangesloten bij [artikel 6:9 van de Awb](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=6:9). Als de belastingschuldige over een bepaald tijdvak geen aangifte heeft gedaan, mag een bestuurder de betalingsonmacht voor dat tijdvak wel melden, mits hij dit doet binnen de termijn die is genoemd in [artikel 7, eerste en tweede lid, van het besluit](https://wetten.overheid.nl/jci1.3:c:BWBR0004772&artikel=7).
...
Er zijn in deze leidraad op de [artikelen 42a](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=42a) en [42c van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=42c) geen beleidsregels gemaakt.
...
### Artikel 63. tot en met [63ab](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=63ab)
...
### 63b.3. Verzuimboete bij niet nakomen verplichting [artikel 60, tweede lid van de wet](onbekend)
...
Er zijn in deze leidraad op de [artikelen 68](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=68), [69](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=69), [70](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70), [70a](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70a), [70aa](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70aa), [70ba](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70ba), [70c](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70c) en [70ca van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=70ca) geen beleidsregels gemaakt.
...
De [WSNP](https://wetten.overheid.nl/jci1.3:c:BWBR0009730) kan ook eindigen zonder schone lei ([artikel 358, tweede lid, Fw](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=358)) en de reeds verstrekte schone lei kan worden ingetrokken ([artikel 358a, eerste lid, Fw](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=358a)). In die situaties kan de ontvanger de invordering hervatten.

### 73.2.4. De [WSNP](https://wetten.overheid.nl/jci1.3:c:BWBR0009730) is tussentijds beëindigd
...
Dit houdt onder meer in dat bij de berekening van de in [artikel 13 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=13) bedoelde betalingscapaciteit op het inkomen van de belastingschuldige niet in mindering wordt gebracht dat deel van het inkomen dat onder het financieel beheer door de schuldhulpverlener valt. Verder wordt opgemerkt dat de middelen die onder financieel beheer van de schuldhulpverlener berusten, niet worden beschouwd als vermogen in de zin van [artikel 12 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=12).
...
Voor zover sprake is van een maatregel tot schadevergoeding, als bedoeld in [artikel 36f, eerste lid, Sr](https://wetten.overheid.nl/jci1.3:c:BWBR0001854&artikel=36f) ten behoeve van slachtoffers of benadeelde derden, of anderszins aan slachtoffers of benadeelde derden tegemoet wordt gekomen, treedt de ontvanger niet terughoudend op.
...
### 22.8.1. Verzet [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) tegen bodembeslag

### 22.8.5. Beroepschriftprocedure ex [artikel 22 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=22)
...
In aansluiting op [artikel 48a van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=48a) beschrijft dit artikel het beleid dat de ontvanger hanteert bij de toepassing van de wettelijke aansprakelijkheid van derden voor belastingaanslagen die samenhangen met bedragen inkomstenbelasting die zijn uitbetaald op een bankrekening waarover die derde heeft kunnen beschikken.
...
Het uitstel wordt in de situatie genoemd bij het eerste gedachtestreepje niet ingetrokken als blijkt dat een verzoek om een schuldregeling, als bedoeld in [artikel 287a van de Faillissementswet](https://wetten.overheid.nl/jci1.3:c:BWBR0001860&artikel=287a), is ingediend bij de rechter. De ontvanger trekt het uitstel in deze situatie niet eerder in, dan nadat de rechter heeft beslist op het verzoek.
...
### 22.8.2. Taken met betrekking tot de schriftelijke mededeling ex [artikel 435, derde lid, Rv](https://wetten.overheid.nl/jci1.3:c:BWBR0001827&artikel=435) inzake bodembeslag
...
### Artikel 28a. en [artikel 28b](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=28b)
...
Voor de door aansprakelijkgestelden verschuldigde kosten die het gevolg zijn van invorderingsmaatregelen die tegen de aansprakelijkgestelde zijn genomen, is [artikel 75](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=75&z=2024-07-01&g=2024-07-01) van overeenkomstige toepassing.
...
Als door de ontvanger of de belastingdeurwaarder op dezelfde dag aan een belastingschuldige meerdere dwangbevelen worden betekend, is de belastingschuldige niet meer betekeningskosten verschuldigd dan het, op grond van [artikel 3, eerste lid, van de Kostenwet invordering rijksbelastingen](https://wetten.overheid.nl/jci1.3:c:BWBR0002645&artikel=3), maximaal in rekening te brengen bedrag voor het betekenen van een dwangbevel.
...
Voor de door aansprakelijkgestelden verschuldigde kosten die het gevolg zijn van invorderingsmaatregelen die tegen de aansprakelijkgestelde zijn genomen, is [artikel 75](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=75&z=2024-01-01&g=2024-01-01) van overeenkomstige toepassing.
...
- 1°. ter zake van de verwerving van die bodemzaak volledige of nagenoeg volledige financiering door de derde is overeengekomen (aankoopfinanciering) waarbij ten behoeve van die derde een pandrecht als bedoeld in [artikel 3:237, eerste lid, van het Burgerlijk Wetboek](https://wetten.overheid.nl/jci1.3:c:BWBR0005291&artikel=237) op de betreffende bodemzaak is gevestigd, indien is voldaan aan de volgende voorwaarden:
...
In afwijking van [artikel 22bis.1., eerste lid](https://wetten.overheid.nl/jci1.3:c:BWBR0024096&artikel=22bis&artikel=22bis.1&z=2024-07-01&g=2024-07-01), geldt de mededelingsplicht voor de onder onderdeel B genoemde gevallen onverkort indien:
...
[Paragraaf 3 van hoofdstuk 2 Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&paragraaf=3) omschrijft de bevoegdheden die Dienst Toeslagen heeft om een teruggevorderde toeslag in te vorderen. Dit hoofdstuk beschrijft het beleid bij invordering van toeslagschuld.

De belastingdeurwaarder is in de [Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472) bevoegd verklaard voor het verrichten van deurwaarderswerkzaamheden in opdracht van Dienst Toeslagen.
...
Op grond van [artikel 32, zesde lid, Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&artikel=32) kan Dienst Toeslagen gebruik maken van de bevoegdheid tot het doen van een vordering ex [artikel 19 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19) onder de werkgever, de uitkeringsinstantie of een andere derde als bedoeld in het [eerste lid van laatstgenoemd artikel](https://wetten.overheid.nl/jci1.3:c:BWBR0004770&artikel=19).
...
Als de belanghebbende door de verrekening van een voorschot kinderopvangtoeslag de lopende kosten voor kinderopvang geheel of gedeeltelijk niet meer kan voldoen, kan hij de Dienst Toeslagen verzoeken de verrekening ongedaan te maken. Als de belanghebbende aannemelijk maakt dat hij door de verrekening een lager bedrag aan bestaansmiddelen overhoudt dan overeenkomt met de voor hem geldende beslagvrije voet, vermeerderd met het bedrag van de lopende kosten van de kinderopvang als bedoeld in [artikel 1.5, eerste lid van de Wet kinderopvang](https://wetten.overheid.nl/jci1.3:c:BWBR0017017&artikel=1.5), met inachtneming van het bepaalde in [artikel 1.7, eerste, tweede en vierde lid van de Wet Kinderopvang](https://wetten.overheid.nl/jci1.3:c:BWBR0017017&artikel=1.7), zal de Dienst Toeslagen rekening houden met de beslagvrije voet, vermeerderd met het bedrag van de lopende kosten voor de kinderopvang van de belanghebbende, vanaf de laatste verrekening die plaatsvond vóór de indiening van het verzoek en bij de daaropvolgende verrekeningen.
...
De [artikelen 11](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=11), [12](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=12) en [13 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=13) en de artikelen 25.5.5 tot en met 25.5.9 zijn hierbij van overeenkomstige toepassing met dien verstande dat:

### 79.9. Geen verdere invorderingsmaatregelen voor toeslagschuld treffen

Zo’n betalingsregeling wordt ook afgewezen als de belanghebbende of de in [artikel 3 van de Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&artikel=3) bedoelde partner over voldoende vermogen in de zin van [artikel 12 van de regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0004766&artikel=12) beschikt voor de voldoening van de terugvordering, met dien verstande dat bevoorrechte schulden op het vermogen in mindering worden gebracht.
...
Voor de toepassing van [artikel 8 Uitvoeringsregeling Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0006736&artikel=8) merkt Dienst Toeslagen een gemotiveerd bezwaarschrift tegen een terugvorderingsbeschikking of een herzieningsverzoek van een terugvorderingsbeschikking aan als een verzoek om uitstel van betaling. In beginsel verleent de Dienst Toeslagen het uitstel, tenzij de belanghebbende ter zake van de betreffende tegemoetkoming of het voorschot daarop onjuiste gegevens heeft verstrekt dan wel de belangen van de Staat zich tegen het verlenen van uitstel verzetten.
...
Als een verzoek van een belanghebbende als bedoeld in artikel 3a van de Awir is toegewezen, dan wordt de eventuele partner als bedoeld in [artikel 3 van de Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&artikel=3) niet als partner aangemerkt voor de toepassing van dit artikel. Dit geldt voor zover de belanghebbende ten tijde van het verzoek om een persoonlijke betalingsregeling nog steeds verblijft in een instelling als bedoeld in artikel 3a van de Awir.

### 79.11. Aansprakelijkheid van derden voor uitbetaalde toeslagen

### 79.12. Beslag door derden op toeslag

Derdenbeslag wordt gelegd onder de Staat der Nederlanden (het organisatieonderdeel Dienst Toeslagen). Dat organisatieonderdeel van de Belastingdienst is het bestuursorgaan dat op grond van de [Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472) is belast met de uitbetaling van de toeslagen.

In aansluiting op [artikel 33 van de Awir](https://wetten.overheid.nl/jci1.3:c:BWBR0018472&artikel=33) beschrijft dit artikel het beleid dat de Dienst Toeslagen hanteert bij de toepassing van de wettelijke aansprakelijkheid van derden voor terugvorderingen die samenhangen met toeslagen die zijn uitbetaald op een bankrekening waarover die derde heeft kunnen beschikken.
