...
Aan de gebruikers van de jaarrekening wordt de resultatenbestemming zichtbaar gemaakt door het in [bijlage A](https://wetten.overheid.nl/jci1.3:c:BWBR0011517&bijlage=A&z=2000-11-25&g=2000-11-25) gehanteerde model.

#### Reserve bedrijfsrisico’s

##### Artikel 5

Op grond van [artikel 22 van de TNO-wet](https://wetten.overheid.nl/jci1.3:c:BWBR0003906&artikel=22) kan een reserve voor bedrijfsrisico’s worden gevormd. De vorming van de reserve voor bedrijfsrisico’s geschiedt als volgt , totdat de maximale omvang van de reserve is bereikt wordt jaarlijks bij de bestemming van het resultaat (conform [artikel 4](https://wetten.overheid.nl/jci1.3:c:BWBR0011517&hoofdstuk=II&artikel=4&z=2000-11-25&g=2000-11-25)) een door de Raad van Bestuur te bepalen percentage van de bijdragen en de opbrengsten van zowel het Rijk (departementen) als van derden aan de reserve toegevoegd.
