...
De in deze code gebruikte begrippen die ook in de [Gaswet](https://wetten.overheid.nl/jci1.3:c:BWBR0011440) worden gebruikt, hebben de betekenis die daaraan in de Gaswet is toegekend. Van de overige in deze code gebruikte begrippen is de betekenis vastgelegd in de [Begrippencode gas](https://wetten.overheid.nl/jci1.3:c:BWBR0037923&wetgeving).

### 2. Het landelijk gastransportnet
...
- a. waarin zich een warmtenet, zoals bedoeld in [artikel 1, onderdeel c, van de Warmtewet](https://wetten.overheid.nl/jci1.3:c:BWBR0033729&artikel=1), bevindt of gaat bevinden tenzij de desbetreffende kleinverbruiker op grond van [artikel 6.10.3 van het Bouwbesluit 2012](https://wetten.overheid.nl/jci1.3:c:BWBR0030461&artikel=6.10) geen aansluiting op het warmtenet heeft (gekregen) waarbij in aanmerking wordt genomen dat het warmtenet, zoals bedoeld in [artikel 1, onderdeel c, van de Warmtewet](https://wetten.overheid.nl/jci1.3:c:BWBR0033729&artikel=1) in het [Bouwbesluit 2012](https://wetten.overheid.nl/jci1.3:c:BWBR0030461) wordt aangeduid als distributienet voor warmte;

- –. conform het door de desbetreffende gemeente opgestelde warmteplan, zoals bedoeld in [artikel 1.1, eerste lid, van het Bouwbesluit 2012](https://wetten.overheid.nl/jci1.3:c:BWBR0030461&artikel=1.1), of
...
- b. 2,5 maal het deel van de leidinglengte dat door gesloten terrein met tegels gaat;

- c. 7 maal het deel van de leidinglengte dat door gesloten terrein met asfalt gaat;

- d. 3 maal het deel van de leidinglengte dat waterkruising betreft;
...
- b. voor een reduceerstation met een capaciteit van 2.500 m3 per uur ten behoeve van meer kleinverbruikers wordt 600 meter opgeteld bij de equivalente netlengte.
