...
- 17). **hogeschool of universiteit:** Een hogeschool of universiteit zoals bedoeld in [artikel 1.8 lid 1 van de Wet op het hoger onderwijs en wetenschappelijk onderzoek](https://wetten.overheid.nl/jci1.3:c:BWBR0005682&artikel=1.8) en de universiteiten genoemd in de Beleidsregel Universiteiten in het Koninkrijk der Nederlanden.
...
- i). [Fair Practice Code](https://fairpracticecode.nl/);

- ii). [Code Diversiteit en Inclusie](https://codedi.nl/);
...
4). De adviescommissie hanteert de [Werkwijze adviescommissies Stimuleringsfonds Creatieve Industrie](https://content.stimuleringsfonds.nl/files/nvg/i_044/sciwerkwijzecommissiesenadviescommissies.pdf/). Hierin staat onder andere de scoringsystematiek beschreven. Hierbij geldt de versie zoals gepubliceerd op de website van het Stimuleringsfonds op het moment van indienen.
