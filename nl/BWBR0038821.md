...
Gelet op de [artikelen 6, derde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=6), [10, zesde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=10), en [15, derde, vierde en vijfde lid, van de Wet arbeidsvoorwaarden gedetacheerde werknemers in de Europese Unie](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=15) en [2a, tweede lid, van de Wet arbeid vreemdelingen](https://wetten.overheid.nl/jci1.3:c:BWBR0007149&artikel=2a);
...
3. In geval van een redelijk vermoeden van onregelmatigheden, verstrekken de door Onze Minister aangewezen ambtenaren de bevoegde instantie van het land van vestiging van de dienstverrichter uit eigen beweging alle relevante gegevens over gedetacheerde werknemers en dienstverrichters, voor zover die gegevens noodzakelijk zijn voor de administratieve samenwerking, bedoeld in [artikel 4, eerste lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=4). Daarbij kan gebruik worden gemaakt van een nationaal identificatienummer, met inbegrip van het burgerservicenummer.
...
- c. de Inspectie Leefomgeving en Transport, voor zover die gegevens noodzakelijk zijn voor het toezicht op de naleving van het bepaalde bij of krachtens de [Arbeidsomstandighedenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0010346) en de [Arbeidstijdenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0007671), met betrekking tot:
...
2. De gegevens, die Onze Minister op grond van [artikel 10a, eerste tot en met vierde lid, van de Wet op het algemeen verbindend en het onverbindend verklaren van bepalingen van collectieve arbeidsovereenkomsten](https://wetten.overheid.nl/jci1.3:c:BWBR0001987&artikel=10a) kan verstrekken uit de onder zijn verantwoordelijkheid gevoerde administraties, betreffen:
...
1. De gegevens, bedoeld in de [artikelen 2 tot en met 4](https://wetten.overheid.nl/jci1.3:c:BWBR0038821&hoofdstuk=II&artikel=2&z=2024-01-01&g=2024-01-01), worden vernietigd na een periode van maximaal 7 jaar, te rekenen vanaf de datum van ontvangst van het gegeven.
...
5. Bij ministeriële regeling kunnen nadere regels worden gesteld met betrekking tot de in acht te nemen termijnen bij de verwerking van gegevens, bedoeld in de [artikelen 2 tot en met 4](https://wetten.overheid.nl/jci1.3:c:BWBR0038821&hoofdstuk=II&artikel=2&z=2024-01-01&g=2024-01-01).
...
- 3°. is ingeschreven in het handelsregister, bedoeld in [artikel 2 van de Handelsregisterwet 2007](https://wetten.overheid.nl/jci1.3:c:BWBR0021777&artikel=2), of een vergelijkbaar register in aangrenzende landen;
...
- 1°. werkzaam is in een in [artikel 8, eerste lid](https://wetten.overheid.nl/jci1.3:c:BWBR0038821&hoofdstuk=IV&artikel=8&z=2024-01-01&g=2024-01-01), genoemde sector van het beroeps- of bedrijfsleven;
...
- k. werknemers die in Nederland zakelijke besprekingen voeren of overeenkomsten sluiten met bedrijven of instellingen, mits hun verblijf niet meer dan 13 weken binnen een tijdsbestek van 52 weken bedraagt;

- l. werknemers die als correspondent werkzaam zijn in dienst van een publiciteitsmedium dat zijn hoofdzetel buiten Nederland gevestigd heeft;

- m. deelnemers aan internationale sportwedstrijden en hun vaste persoonlijke begeleiders, mits hun verblijf niet meer dan 6 aaneengesloten weken binnen een tijdsbestek van 13 weken bedraagt;

- n. artiesten en musici, en hun vaste persoonlijk begeleiders die een voorstelling uitvoeren, beeldend kunstenaars, conservators of restauratoren, mits hun verblijf niet meer dan 6 aaneengesloten weken binnen een tijdsbestek van 13 weken bedraagt;
...
2. [Artikel 8 van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=8) is niet van toepassing op de dienstverrichter op wie de verplichting van [artikel 9e](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=9e) of [artikel 9g van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=9g) van toepassing is.
...
2. Als soortgelijke verplichtingen en verboden als bedoeld in [artikel 15, vierde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=15) worden aangewezen de informatie- en administratieve verplichtingen op grond van de [artikelen 6, eerste en tweede lid](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=6), [8, eerste, derde en zesde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=8), en [9, eerste tot en met derde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=9) en de verplichting op grond van [artikel 2a van de Wet arbeid vreemdelingen](https://wetten.overheid.nl/jci1.3:c:BWBR0007149&artikel=2a).

3. Voor de toepassing van [artikel 15, derde tot en met vijfde lid, van de wet](https://wetten.overheid.nl/jci1.3:c:BWBR0038054&artikel=15) worden overtredingen die zijn begaan voor 9 december 2016 niet in aanmerking genomen.
