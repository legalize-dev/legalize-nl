...
| A | omzet behaald met de exploitatie van de vergunning | omzet behaald met de exploitatie van de vergunning | omzet behaald met de exploitatie van de vergunning | omzet behaald met de exploitatie van de vergunning |
| --- | --- | --- | --- | --- |
| A.1 | **omzet van de vergunninghouder (onderscheiden naar prijs- en hoeveelheidscomponent):** | **omzet van de vergunninghouder (onderscheiden naar prijs- en hoeveelheidscomponent):** | **omzet van de vergunninghouder (onderscheiden naar prijs- en hoeveelheidscomponent):** | **omzet van de vergunninghouder (onderscheiden naar prijs- en hoeveelheidscomponent):** |
| (i) | omzet uit abonnementen af: verstrekte kortingen | Ai -/- K(Ai) | Ai -/- K(Ai) |   |
| (ii) | omzet uit set-top boxes af: verstrekte kortingen | Aii -/- K(Aii) | Aii -/- K(Aii) |   |
| (iii) | omzet uit betaal-tv af: verstrekte kortingen | Aiii -/- K(Aiii) | Aiii -/- K(Aiii) |   |
| (iv) | omzet uit data-casting af: verstrekte kortingen | Aiv -/- K(Aiv) | Aiv -/- K(Aiv) |   |
| (v) | overige omzet Av af: verstrekte kortingen | Av -/- K(Av) | +/+ |   |
|   | **netto-omzet van de vergunninghouder** | SUM ((Ai..Av)- (KAi..Av) = | SUM ((Ai..Av)- (KAi..Av) = | A1 |
...
| B.1 | betalingen aan in de rechtspersoon van de vergunning houder deelnemende organisaties of personen of aan hen gelieerde organisaties | B1 | B1 |   |
| B.2 | in het boekjaar aangegane samenwerkingsvormen die het gebruik van de frequenties betreffen en de financiële gevolgen ervan | B2 | B2 |   |
| B.3 | in het boekjaar verworven deelnemingen | B3 | B3 |   |
