...
**Onderdeel b:** de functietitel van de leidinggevende van de inspectie is afhankelijk van een aantal factoren die zijn beschreven in het Kader Topstructuur en Topfuncties Rijk 2007, dat geldt als een kader in de zin van [artikel 3, lid 1, van het Coördinatiebesluit organisatie en bedrijfsvoering rijksdienst 2011](https://wetten.overheid.nl/jci1.3:c:BWBR0029514&artikel=3).9De NVWA, IGZ, IvhO, SodM, ILT en ISZW worden geleid door een Inspecteur-Generaal. De EGI heeft een directeur, de IJZ wordt geleid door een hoofdinspecteur, de IVenJ door een hoofd en het AT door een directeur-hoofdinspecteur. In deze aanwijzingen wordt in algemene zin de aanduiding ‘inspecteur-generaal’ (IG) gebruikt voor de leidinggevende van de rijksinspectie, ook als de facto de aanduiding anders luidt.
