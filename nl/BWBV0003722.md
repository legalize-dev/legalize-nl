...
- 3.2.9. The agreement mentioned in 3.1 is not required if the proposed modification either: In either case, the administration intending to modify the Plan may put its project into effect, subject to the application of the provisions of Article 9 *or the corresponding article of the Radio Regulations currently in force.of the Radio Regulations.
