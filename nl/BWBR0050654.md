...
3. Het lidmaatschap van de cliëntenraad heeft geen invloed op de behandeling van het lid door het CAK.
...
- c. als naar het oordeel van de voorzitter of de Raad van Bestuur de goede gang van zaken bij de werkzaamheden van de cliëntenraad door toedoen van het lid wordt belemmerd.
...
2. In het jaarverslag van het CAK wordt gerapporteerd over de activiteiten van de cliëntenraad in het verslagjaar.
...
2. Voor de activiteiten van de cliëntenraad stelt het CAK de cliëntenraad, waar nodig, een budget ter beschikking. Deze kosten worden zoveel mogelijk begroot in het activiteitenplan. De Raad van Bestuur stelt de hoogte van het budget vast.
