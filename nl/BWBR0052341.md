...
status: "in_force"
source: "https://wetten.overheid.nl/BWBR0052341"
soort: "zbo"
stam_id: "17774463"
version_id: "31421562"
internal_id: "C44889311"
label_id: "17673074"
dtd_version: "2.0"
original_entry_into_force: "2026-02-21"
toestand_uri: "http://wetten.overheid.nl/id/BWBR0052341/2026-05-28/0"
intitule_bron: "Stcrt.2026-4106"
intitule_effect: "nieuwe-regeling"
intitule_signed: "2026-02-05"
intitule_published: "2026-02-20"
intitule_in_force: "2026-02-20"
intitule_status: "goed"
original_publication: "Stcrt.2026-4106"
original_signed_date: "2026-02-05"
original_published_date: "2026-02-20"
original_effect: "nieuwe-regeling"
original_url_id: "stcrt-2026-4106"
entry_into_force_date: "2026-02-21"
jci_1_3: "jci1.3:c:BWBR0052341&z=2026-05-28&g=2026-05-28"
jci_1_0: "1.0:c:BWBR0052341&g=2026-05-28"
citeertitel_status: "officieel"
short_title: "Tarievencode gas TSB en DSB"
...
1. Voor de toepassing van deze code gelden de begrippen en bijbehorende begripsbepalingen uit de [Energiewet](https://wetten.overheid.nl/jci1.3:c:BWBR0050714), uit de [Begrippencode gas TSB en DSB](https://wetten.overheid.nl/jci1.3:c:BWBR0052329) en, voor zover het de transmissiesysteembeheerder betreft, uit NC-TAR.
...
1. De aansluitdienst omvat het verrichten van alle werkzaamheden en het leveren van alle benodigdheden om een aangeslotene te voorzien van een aansluiting en deze aansluiting te beheren en te onderhouden, daaronder mede begrepen werkzaamheden die de distributiesysteembeheerder aan de bestrating moet verrichten bij het aanleggen of in stand houden van een aansluiting.
...
3. Componenten buiten de in het tweede lid genoemde reikwijdte die de distributiesysteembeheerder aanlegt dan wel in standhoudt, vallen buiten het bereik van de aansluitdienst.

4. Behoudens werkzaamheden die nodig zijn om het aansluitpunt tot stand te brengen en te beheren en onderhouden, vallen werkzaamheden aan het distributiesysteem van de distributiesysteembeheerder, ongeacht de aard of bedoeling daarvan, niet onder het bereik van de aansluitdienst.
...
- a. de distributiesysteembeheerder de lengte van de aansluitleiding gelijk stelt aan de lengte van het tracé tussen het overdrachtspunt en het punt waarop wordt aangesloten in het distributiesysteem of, indien van toepassing, op een bestaande aansluiting.
...
#### § 2.3. Algemene bepalingen voor de tariefstructuur voor de transportdienst

###### Artikel 2.19

1. De transportdienst omvat het transporteren van gas voor aangeslotenen door gebruik te maken van het distributiesysteem. Hieronder wordt mede verstaan:

- a. de instandhouding van het distributiesysteem;
...
- a. een transportonafhankelijk tarief

- b. een transportafhankelijk tarief

###### Artikel 2.22

1. De distributiesysteembeheerder deelt de kleine aansluitingen in transporttariefcategorieën in op basis van de aansluitcapaciteit en, voor zover van toepassing, het standaardjaarverbruik.
...
De procedure voor indeling van een kleine aansluiting in een andere afnemersgroep transporttariefcategorie is als volgt:

- a. indien een kleinverbruiker die beschikt over een kleine aansluiting op grond van zijn benodigde maximale (gesommeerde) transportcapaciteit van mening is dat hij in aanmerking komt voor indeling in een andere transporttariefcategorie, dient hij daartoe een schriftelijk verzoek in bij de distributiesysteembeheerder op wiens systeem zijn installatie is aangesloten;
...
- d. daarna neemt de kleinverbruiker contact op met zijn meetverantwoordelijke om ervoor te zorgen dat zijn metercapaciteit op kosten van de kleinverbruiker wordt bijgesteld door aanpassing (wisseling) van de meter;

- e. indien de meetinrichting is aangepast, informeert de meetverantwoordelijke de distributiesysteembeheerder;
...
1. Het transportonafhankelijke tarief voor kleinverbruikers wordt bepaald door de aan deze aansluitingen toegerekende transportonafhankelijke kosten te delen door het aantal kleinverbruikaansluitingen.

2. Het transportonafhankelijke tarief is een bedrag voor de periode van een jaar en wordt per aansluiting in rekening gebracht.
...
4. De distributiesysteembeheerder brengt het transportafhankelijke tarief in rekening over de rekencapaciteit per aansluiting. Voor aansluitingen met meerdere verbindingen brengt de distributiesysteembeheerder het transportafhankelijke tarief in rekening over de som van de rekencapaciteiten van die verbindingen.

###### Artikel 2.26

[vervallen]

#### § 2.5. De tariefstructuur van de transporttarieven voor profielverbruikers

###### Artikel 2.27

De transporttarieven voor profielverbruikers bestaan uit de volgende componenten:
...
1. De distributiesysteembeheerder deelt de profielverbruikaansluitingen in transporttariefcategorieën in op basis van de aansluitcapaciteit.
...
De procedure voor indeling van een profielverbruikaansluiting in een andere transporttariefcategorie is als volgt:

- a. indien een profielverbruiker op grond van zijn benodigde maximale (gesommeerde) transportcapaciteit van mening is dat hij in aanmerking komt voor indeling in een andere transporttariefcategorie, dient hij daartoe een schriftelijk verzoek in bij de distributiesysteembeheerder op wiens systeem zijn installatie is aangesloten;
...
- d. daarna neemt de profielverbruiker contact op met zijn meetverantwoordelijke om ervoor te zorgen dat zijn metercapaciteit op kosten van de profielverbruiker wordt bijgesteld door aanpassing (wisseling) van de meter;
...
1. Het transportonafhankelijke tarief voor profielverbruikers wordt bepaald door de aan deze aansluitingen toegerekende transportonafhankelijke kosten te delen door het aantal profielverbruikaansluitingen.
...
4. De distributiesysteembeheerder brengt het transportafhankelijke tarief in rekening over de rekencapaciteit per aansluiting. Voor aansluitingen met meerdere verbindingen brengt de systeembeheerder het transportafhankelijke tarief in rekening over de som van de rekencapaciteiten van die verbindingen.

#### § 2.6. De tariefstructuur van de transporttarieven voor telemetrieverbruikers

###### Artikel 2.32

De transporttarieven voor telemetrieverbruikers bestaan uit de volgende componenten:
...
4. Een aanpassing van de gecontracteerde transportcapaciteit, en zodoende het aangepaste transporttarief, is van kracht met ingang van de maand volgend op de instemming met en de uitvoering van het verzoek door de distributiesysteembeheerder.

###### Artikel 2.34

1. Het transportonafhankelijke tarief voor telemetrieverbruikers wordt bepaald door de aan telemetrieverbruikaansluitingen toegerekende transportonafhankelijke kosten te delen het aantal telemetrieverbruikaansluitingen.

2. Het transportonafhankelijke tarief, bedoeld in het eerste lid, is een bedrag voor de periode van een jaar en wordt per aansluiting in rekening gebracht.

###### Artikel 2.35

1. Het transportafhankelijke tarief voor telemetrieverbruikers wordt berekend door de totale op basis van capaciteit aan telemetrieverbruikaansluitingen transportafhankelijke kosten te delen door de som van de door telemetrieverbruikers gecontracteerde transportcapaciteit.

2. De distributiesysteembeheerder kan bij de berekening van het transportafhankelijke tarief, als bedoeld in het eerste lid, ervoor kiezen onderscheid te maken naar type systeem waarop telemetrieverbruikers zijn aangesloten

3. Indien de distributiesysteembeheerder onderscheid maakt naar type systeem, als bedoeld in het tweede lid, berekent hij de transportafhankelijke kosten voor telemetrieverbruikaansluitingen per type systeem. Hiertoe cascadeert de distributiesysteembeheerder deze transportafhankelijke kosten van het extrahogedruksysteem door naar het hogedruksysteem en lagedruksysteem, en de transportafhankelijke kosten van het hogedruksysteem door naar het lagedruksysteem.

4. Voor het cascaderen van de transportafhankelijke kosten van het extrahogedruksysteem aan het hogedruksysteem, als bedoeld in het derde lid, hanteert de distributiesysteembeheerder het quotiënt van de afname, uitgedrukt in m3(n)/uur, van het hogedruksysteem en lagedruksysteem die worden gevoed vanuit het betreffende extrahogedruksysteem, en de afname, uitgedrukt in m3(n)/uur, van het betreffende lagedruksysteem, hogedruksysteem en extrahogedruksysteem samen.

5. Voor het cascaderen van de transportafhankelijke kosten van het hogedruk systeem aan het lagedruk systeem, als bedoeld in het derde lid, hanteert de distributiesysteembeheerder het quotiënt van de getransporteerde volume, uitgedrukt in m3(n)/uur, van het lagedruk systeem dat wordt gevoed vanuit het betreffende hogedruk systeem, en de afname, uitgedrukt in m3(n)/uur, van het betreffende lagedruk systeem en hogedruk systeem samen.

6. Het transportafhankelijke tarief wordt op basis van de gecontracteerde transportcapaciteit per aansluiting in rekening gebracht.

7. Wanneer een telemetrieverbruiker op enig moment de gecontracteerde transportcapaciteit overschrijdt dan brengt de distributiesysteembeheerder hem een overschrijdingsvergoeding in rekening over de hoeveelheid capaciteit waarmee de gecontracteerde capaciteit wordt overschreden. Deze vergoeding bestaat uit het transportafhankelijke tarief en wordt met terugwerkende kracht voor het gehele contractjaar berekend.
...
4. De distributiesysteembeheerder berekent het additionele tarief, bedoeld in het derde lid, per m3(n; 35,17)/uur door het quotiënt te nemen van de duur van de door de distributiesysteembeheerder gewenste afschakelingen die door de afnemer niet worden opgevolgd, uitgedrukt in dagen, en 365 en dat te vermenigvuldigen met het transportafhankelijke verbruikerstarief. Het additionele tarief is onafhankelijk van de duur van de afschakeling op een dag.

###### Artikel 2.37

1. Onder een dagcontract voor telemetrieverbruikers wordt een overeenkomst verstaan die een kortere looptijd heeft dan een jaar.
...
- b. wanneer een telemetrieverbruiker op enig moment de gecontracteerde dagcapaciteit overschrijdt dan brengt de distributiesysteembeheerder hem een overschrijdingsvergoeding in rekening over de hoeveelheid capaciteit waarmee de gecontracteerde capaciteit wordt overschreden. Deze vergoeding wordt met terugwerkende kracht voor de gehele dag berekend en bestaat uit het transportafhankelijk verbruikstarief per dag.

3. De distributiesysteembeheerder gaat akkoord met de aanvraag voor een dagcontract, indien:
...
3. De procentuele korting op de niet-aangepaste referentieprijzen van toepassing op entrypunten van een LNG-faciliteit als bedoeld in het eerste lid is 0%.

4. Als een gasopslagsystemen rechtstreeks is verbonden met meer dan één transmissie- of distributiesysteem en derhalve gebruikt kan worden om gas van het Nederlandse transmissiesysteem naar een rechtstreeks verbonden transmissie- of distributiesysteem gelegen in een andere lidstaat te transporteren, waardoor de gasopslagsystemen gebruikt kan worden om te concurreren met een interconnectiepunt, dan is er geen gasopslagkorting van toepassing en moet het volledige tarief worden betaald. In dat geval is de referentieprijs voor een entrypunt van een gasopslagsystemen of voor een exitpunt naar een gasopslagsystemen gelijk aan
...
- a. Het entry- en exittarief te bepalen dat een netgebruiker op het betreffende entry- en exitpunt verschuldigd is voor het contracteren van vaste entry- of exitcapaciteit; en
...
1. Indien de gecontracteerde entry- of exitcapaciteit wordt overschreden brengt de transmissiesysteembeheerder de systeemgebruiker een tarief in rekening voor de overschrijding van de gecontracteerde entry- of exitcapaciteit.
...
De [Tarievencode gas](https://wetten.overheid.nl/jci1.3:c:BWBR0037948) wordt ingetrokken.
