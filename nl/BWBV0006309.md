...
Delegates whose credentials fail to meet the criteria of subparagraphs (a), (b) and (c) above shall be entitled only to take part in debates and vote.
...
The motion on a point of order shall take precedence over all other questions, including the procedural motions referred to in paragraph 3 below.
...
Procedural motions shall take precedence, in the order set out above, over all other proposals except the motions on points of order referred to in paragraph 1 above.
